...
class StandMixerAlertDialog extends StatefulWidget {
  ...
  ///List of [StandMixerAlertPopupAction] items that will populate the buttons at the bottom of the dialog.
  ///Buttons will be presented from top to bottom in the order they are initialized here.
  final List<StandMixerAlertPopupAction> buttonActions;
  const StandMixerAlertDialog({
      required this.title,
  ...
  @override
  State<StandMixerAlertDialog> createState() => _StandMixerAlertDialogState();
}

class _StandMixerAlertDialogState extends State<StandMixerAlertDialog> {
  int dialogHeight = 61;
            ...
            child: Column(
              ...
              children: [
                MeasureSize(
                  ...
                  child: Padding(
                    padding: widget.titlePadding ?? EdgeInsets.only(left: 20.w, right: 20.w, top: 10.h),
                ...
                SizedBox(
                  height: widget.buttonActions.length > 1 ? widget.buttonActions.length * 50 : 70.h,
...
class StandMixerAlertPopupAction {
  final String title;
  final Function action;
  Color backgroundColor = Colors.transparent;
  StandMixerAlertPopupAction({required this.title, required this.action});
}