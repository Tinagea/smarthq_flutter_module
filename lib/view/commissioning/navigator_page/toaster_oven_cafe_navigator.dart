...
import 'package:smarthq_flutter_module/view/commissioning/appliance_page/countertops/toaster_oven/toaster_oven_cafe_getting_started_page.dart' as ToasterOven;
...
class ToasterOvenCafeNavigator extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return WillPopScope(
      onWillPop: () async => false,
      child: Navigator(
        initialRoute: Routes.TOASTER_OVEN_CAFE_DESCRIPTION1_MODEL,
        onGenerateRoute: (RouteSettings settings) {
          WidgetBuilder builder;
          switch (settings.name) {
            case Routes.TOASTER_OVEN_CAFE_DESCRIPTION1_MODEL:
              builder = (BuildContext _) => ToasterOven.ToasterOvenCafeCommissioningStep1();
              break;
