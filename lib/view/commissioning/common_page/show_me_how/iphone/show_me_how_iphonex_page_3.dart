...
class ShowMeHowIphoneXPage3 extends StatelessWidget {
  @override
                ...
                child: ListView(
                  children: <Widget>[
                    Component.componentMainImage(
                        context,
                        ImagePath.SHOW_ME_HOW_IPHONEX_MAINIMAGE3_PATH),
                    BaseComponent.heightSpace(16.h),
                    CustomRichText.customSpanListTextBox(
                      textSpanList: <TextSpan>[
                        TextSpan(
                            text: LocaleUtil.getString(context, LocaleUtil.SHOW_ME_HOW_IPHONE_PAGE3_DESCRIPTION)! + " \"",
