...
class DryerFrontModel1Description extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => _DryerFrontModel1Description();
}

class _DryerFrontModel1Description extends State<DryerFrontModel1Description>
                      ...
                      BlocListener<BleCommissioningCubit, BleCommissioningState>(
                        ...
                        listener: (context, state) {
                          ...
                          if (state.isSuccess == true) {
                            ...
                            globals.routeNameToBack = Routes.DRYER_FRONT_MODEL1;
                            Navigator.of(context).pushNamed(Routes.DRYER_FRONT_1_PASSWORD);
                          }
                        },
                        child: Container(),
                      ),
                      Component.componentMainImage(context,
                          ImagePath.DRYER_FRONT_1_COLOR),
