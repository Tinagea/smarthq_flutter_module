...
class DryerAppliancePasswordHaierPage extends StatefulWidget {
  DryerAppliancePasswordHaierPage({Key? key}) : super(key: key);

  _DryerAppliancePasswordHaierPageState createState() => _DryerAppliancePasswordHaierPageState();
}

class _DryerAppliancePasswordHaierPageState extends State<DryerAppliancePasswordHaierPage> {
  var onTapRecognizer;
                    ...
                    child: ListView(
                      ...
                      children: <Widget>[
                        ...
                        Component.componentMainImage(
                            context, ImagePath.LAUNDRY_FRONT_1_PASSWORD_2_FNP),
                        BaseComponent.heightSpace(16.h),
                            ...
                            RichText(
                              ...
                              TextSpan(
                                  text: LocaleUtil.getString(
                                      context,
                                      LocaleUtil
                                          .LAUNDRY_DRYER_HAIER_FRONT_1_ENTER_PASSWORD_1),
                                  style: textStyle_size_18_color_white()),
                              TextSpan(
                                  text: LocaleUtil.getString(
                                      context,
                                      LocaleUtil
                                          .LAUNDRY_DRYER_HAIER_FRONT_1_ENTER_PASSWORD_2),
                                  style: textStyle_size_18_color_yellow()),
                              TextSpan(
                                  text: LocaleUtil.getString(
                                      context,
                                      LocaleUtil
                                          .LAUNDRY_DRYER_HAIER_FRONT_1_ENTER_PASSWORD_3),
                                  style: textStyle_size_18_color_white())
                            ])),
