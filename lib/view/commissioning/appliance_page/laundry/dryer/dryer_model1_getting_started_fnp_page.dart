...
class DryerModel1GettingStartedFnpPage extends StatefulWidget {
  @override
  State createState() => _DryerModel1GettingStartedFnpPageState();
}

class _DryerModel1GettingStartedFnpPageState
    extends State<DryerModel1GettingStartedFnpPage>
                    ...
                    children: <Widget>[
                      Padding(
                        ...
                        child: Component.componentMainImage(
                          context,
                          ImagePath.LAUNDRY_FRONT_DRYER_1_REMOTE_WIFI,
                        ),
                      ),
                            ...
                            children: [
                              TextSpan(
                                text: LocaleUtil.getString(
                                    context,
                                    LocaleUtil
                                        .LAUNDRY_DRYER_FNP_FRONT_MODEL_1_DESCRIPTION_TEXT_1),
                              ...
                              TextSpan(
                                text: LocaleUtil.getString(
                                    context,
                                    LocaleUtil
                                        .LAUNDRY_DRYER_FNP_FRONT_MODEL_1_DESCRIPTION_TEXT_2),
                                style: textStyle_size_18_color_white(),
                              ),
                              WidgetSpan(
                              ...
                              TextSpan(
                                text: LocaleUtil.getString(
                                    context,
                                    LocaleUtil
                                        .LAUNDRY_DRYER_FNP_FRONT_MODEL_1_DESCRIPTION_TEXT_3),
                                style: textStyle_size_18_color_white(),
                              ),
                            ],
                          ),
  ...
  void _navigateToNextPage(BuildContext context) {
    Navigator.of(context).pushNamed(Routes.DRYER_MODEL_1_PASSWORD_FNP);
  }
