...
class DryerFront2PasswordPage extends StatefulWidget {
  DryerFront2PasswordPage({Key? key}) : super(key: key);

  _DryerFront2PasswordPage createState() => _DryerFront2PasswordPage();
}

class _DryerFront2PasswordPage extends State<DryerFront2PasswordPage> {
        ...
        child: WillPopScope(
            ...
            child: Scaffold(
              ...
              appBar: CommonAppBar(
                  ...
                  leftBtnFunction: () {
                    CommissioningUtil.navigateBackAndStopBlescan(
                        context: context);
                    ...
                    builder: (context, snapshot) {
                      ...
                      return Column(
                        children: [
                                ...
                                CustomRichText.customSpanListTextBox(
                                    textSpanList: <TextSpan>[
                                      TextSpan(
                                          ...
                                          style:
                                              textStyle_size_18_color_white()),
                                      TextSpan(
                                          text: LocaleUtil.getString(context,
                                              LocaleUtil.ENTER_PASSWORD_TEXT_2),
                                          style:
                                              textStyle_size_18_color_yellow()),
                                      TextSpan(
                                          text: LocaleUtil.getString(context,
                                ...
                                Visibility(
                                  ...
                                  child: CommissioningPassword()
                                      .getPinCodeTextField1(
                                          ...
                                          onCompleted: (value) {
                                            BlocProvider.of<CommissioningCubit>(
                                                    context)
                          ...
                          AutoJoinBlocListener.handleAutoJoinResponse(
                              loadingDialog,
                              restartContinuousScan: true),
                                ...
                                if (_isAutoJoinSupport) {
                                  loadingDialog.show(
                                      ...
                                      LocaleUtil.getString(
                                          context,
                                          LocaleUtil
                                              .CONNECTING_TO_YOUR_APPLIANCE));

                                  BlocProvider.of<CommissioningCubit>(context)
                                      .startProcessing('GE_MODULE_$_moduleSsid',
                                          _acmPassword);
                                } else {
                                  ...
                                  Navigator.of(context, rootNavigator: true)
                                      ...
                                      .then((_) => BlocProvider.of<
                                              BleCommissioningCubit>(context)
