...
class DryerSelectDisplayFnpPage extends StatelessWidget {
  @override
        ...
        body: ListView(
          children: <Widget>[
            ...
            Component.componentMainSelectImageButton(
                context: context,
                pushName: Routes.DRYER_MODEL_1_GETTING_STARTED_FNP,
            ...
            Component.componentMainSelectImageButton(
                context: context,
                pushName: Routes.DRYER_MODEL_2_GETTING_STARTED_FNP,
