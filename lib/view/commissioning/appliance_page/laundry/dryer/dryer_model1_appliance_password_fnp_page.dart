...
class DryerModel1AppliancePasswordFnpPage extends StatefulWidget {
  DryerModel1AppliancePasswordFnpPage({Key? key}) : super(key: key);

  _DryerModel1AppliancePasswordFnpPageState createState() =>
      _DryerModel1AppliancePasswordFnpPageState();
}

class _DryerModel1AppliancePasswordFnpPageState
    extends State<DryerModel1AppliancePasswordFnpPage> {
  var onTapRecognizer;
                    ...
                    child: ListView(
                      ...
                      children: <Widget>[
                        ...
                        Component.componentMainImage(
                            context, ImagePath.LAUNDRY_FRONT_1_PASSWORD_FNP),
                        BaseComponent.heightSpace(16.h),
                            ...
                            RichText(
                              ...
                              TextSpan(
                                  text: LocaleUtil.getString(
                                      context,
                                      LocaleUtil
                                          .LAUNDRY_DRYER_FNP_FRONT_1_ENTER_PASSWORD_1),
                                  style: textStyle_size_18_color_white()),
                              TextSpan(
                                  text: LocaleUtil.getString(
                                      context,
                                      LocaleUtil
                                          .LAUNDRY_DRYER_FNP_FRONT_1_ENTER_PASSWORD_2),
                                  style: textStyle_size_18_color_yellow()),
                              TextSpan(
                                  text: LocaleUtil.getString(
                                      context,
                                      LocaleUtil
                                          .LAUNDRY_DRYER_FNP_FRONT_1_ENTER_PASSWORD_3),
                                  style: textStyle_size_18_color_white())
                            ])),
