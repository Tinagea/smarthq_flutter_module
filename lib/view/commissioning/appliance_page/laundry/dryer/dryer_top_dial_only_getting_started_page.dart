...
class DryerTopModel1Description extends StatefulWidget {

  @override
  State createState() => _DryerTopModel1Description();
}

class _DryerTopModel1Description extends State<DryerTopModel1Description>
                ...
                BlocListener<BleCommissioningCubit, BleCommissioningState>(
                  ...
                  listener: (context, state) {
                    ...
                    if (state.isSuccess == true) {
                      ...
                      globals.routeNameToBack = Routes.DRYER_TOP_MODEL1;
                      Navigator.of(context).pushNamed(Routes.DRYER_TOP_PASSWORD);
                    }
                  },
                  child: Container(),
                ),
                      ...
                      CustomRichText.addWifiTextBox(
                          spanStringList: [
                            TextSpan(text: LocaleUtil.getString(
                                context, LocaleUtil.LAUNDRY_TOP_1_P1_WIFI),
                            ...
                            TextSpan(text: LocaleUtil.getString(
                                context, LocaleUtil.LAUNDRY_TOP_1_P2_WIFI),
                                style: textStyle_size_18_color_white()),
                          ],
                      ...
                      return Component.componentBottomButton(
                          ...
                          onTapButton: () {
                            BlocProvider.of<BleCommissioningCubit>(context)
                                .actionBleStartPairingAction2(ApplianceType.LAUNDRY_DRYER, () {
                                  globals.routeNameToBack = Routes.DRYER_TOP_MODEL1;
                                  Navigator.of(context).pushNamed(Routes.DRYER_TOP_PASSWORD);
