...
class DryerGettingStartedHaierPage extends StatefulWidget {
  @override
  State createState() => _DryerGettingStartedHaierPageState();
}

class _DryerGettingStartedHaierPageState
    extends State<DryerGettingStartedHaierPage> with WidgetsBindingObserver {
  @override
                              ...
                              children: [
                                TextSpan(
                                  text: LocaleUtil.getString(
                                      context,
                                      LocaleUtil
                                          .LAUNDRY_DRYER_HAIER_FRONT_MODEL_1_DESCRIPTION_TEXT_1),
                                ...
                                TextSpan(
                                  text: LocaleUtil.getString(
                                      context,
                                      LocaleUtil
                                          .LAUNDRY_DRYER_HAIER_FRONT_MODEL_1_DESCRIPTION_TEXT_2),
                                ...
                                TextSpan(
                                  text: LocaleUtil.getString(
                                      context,
                                      LocaleUtil
                                          .LAUNDRY_DRYER_HAIER_FRONT_MODEL_1_DESCRIPTION_TEXT_3),
                                  style: textStyle_size_18_color_white(),
                                ),
                                WidgetSpan(
                                  child: Icon(
                                ...
                                TextSpan(
                                  text: LocaleUtil.getString(
                                      context,
                                      LocaleUtil
                                          .LAUNDRY_DRYER_HAIER_FRONT_MODEL_1_DESCRIPTION_TEXT_4),
                                  style: textStyle_size_18_color_white(),
                                ),
                              ],
                            ),
  ...
  void _navigateToNextPage(BuildContext context) {
    Navigator.of(context).pushNamed(Routes.DRYER_MODEL_1_PASSWORD_HAIER);
  }
