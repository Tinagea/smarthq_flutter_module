...
class DryerFront1PasswordPage extends StatefulWidget {
  DryerFront1PasswordPage({Key? key}) : super(key: key);

  _DryerFront1PasswordPage createState() => _DryerFront1PasswordPage();
}

class _DryerFront1PasswordPage extends State<DryerFront1PasswordPage> {
