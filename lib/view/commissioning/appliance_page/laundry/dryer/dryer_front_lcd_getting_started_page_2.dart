...
class DryerFrontModel2Step2 extends StatefulWidget {

  @override
  State createState() => _DryerFrontModel2Step2();
}

class _DryerFrontModel2Step2 extends State<DryerFrontModel2Step2> {
                        ...
                        BlocListener<BleCommissioningCubit, BleCommissioningState>(
                          ...
                          listener: (context, state) {
                            ...
                            if (state.isSuccess == true) {
                              ...
                              globals.routeNameToBack = Routes.DRYER_FRONT_MODEL2_STEP1;
                              Navigator.of(context).pushNamed(Routes.DRYER_FRONT_2_PASSWORD);
                            }
                          },
                          child: Container(),
                        ),
