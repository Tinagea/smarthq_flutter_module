...
class DryerTopPasswordPage extends StatefulWidget {
  DryerTopPasswordPage({Key? key}) : super(key: key);

  _DryerTopPasswordPage createState() => _DryerTopPasswordPage();
}

class _DryerTopPasswordPage extends State<DryerTopPasswordPage> {
                          ...
                          child: ListView(
                            ...
                            children: <Widget>[
                              Component.componentMainImage(
                                  context, ImagePath.DRYER_TOP_PASSWORD),
