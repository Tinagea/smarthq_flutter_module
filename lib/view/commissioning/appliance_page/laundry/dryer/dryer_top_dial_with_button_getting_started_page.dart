...
class DryerTopModel3Description extends StatefulWidget {

  @override
  State createState() => _DryerTopModel3Description();
}

class _DryerTopModel3Description extends State<DryerTopModel3Description>
                ...
                BlocListener<BleCommissioningCubit, BleCommissioningState>(
                  ...
                  listener: (context, state) {
                    ...
                    if (state.isSuccess == true) {
                      ...
                      globals.routeNameToBack = Routes.DRYER_TOP_MODEL3;
                      ...
                      CustomRichText.addWifiTextBox(
                          spanStringList: [
                            TextSpan(text: LocaleUtil.getString(
                                context, LocaleUtil.LAUNDRY_TOP_3_P1_WIFI),
                            ...
                            TextSpan(text: LocaleUtil.getString(
                                context, LocaleUtil.LAUNDRY_TOP_3_P2_WIFI),
                                style: textStyle_size_18_color_white()),
                          ],
