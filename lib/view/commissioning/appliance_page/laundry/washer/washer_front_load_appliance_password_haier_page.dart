...
class WasherFrontLoadAppliancePasswordHaierPage extends StatefulWidget {
  WasherFrontLoadAppliancePasswordHaierPage({Key? key}) : super(key: key);

  _WasherFrontLoadAppliancePasswordHaierPageState createState() => _WasherFrontLoadAppliancePasswordHaierPageState();
}

class _WasherFrontLoadAppliancePasswordHaierPageState extends State<WasherFrontLoadAppliancePasswordHaierPage> {
  var onTapRecognizer;
