...
class WasherFrontLoadType extends StatelessWidget {
  @override
        ...
        body: SingleChildScrollView(
          child: Wrap(
              ...
              Component.componentMainSelectImageButton(
                  context: context,
                  pushName: Routes.WASHER_FRONT_MODEL1,
                  imageName: ImagePath.WASHER_FRONT_1),
              Component.componentMainSelectImageButton(
                  context: context,
                  pushName: Routes.WASHER_FRONT_MODEL2_STEP1,
                  imageName: ImagePath.LAUNDRY_FRONT_2)
            ]
          ),
        ),
      ),
