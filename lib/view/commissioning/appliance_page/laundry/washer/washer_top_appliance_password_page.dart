...
class WasherTopPasswordPage extends StatefulWidget {
  WasherTopPasswordPage({Key? key}) : super(key: key);

  _WasherTopPasswordPage createState() => _WasherTopPasswordPage();
}

class _WasherTopPasswordPage extends State<WasherTopPasswordPage> {
                        ...
                        child: ListView(
                          ...
                          children: <Widget>[
                            Component.componentMainImage(
                                context, ImagePath.WASHER_TOP_PASSWORD),
