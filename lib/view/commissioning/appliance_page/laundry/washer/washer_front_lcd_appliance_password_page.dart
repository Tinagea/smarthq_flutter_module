...
class WasherFront2PasswordPage extends StatefulWidget {
  WasherFront2PasswordPage({Key? key}) : super(key: key);

  _WasherFront2PasswordPage createState() => _WasherFront2PasswordPage();
}

class _WasherFront2PasswordPage extends State<WasherFront2PasswordPage> {
                        ...
                        child: ListView(
                          ...
                          children: <Widget>[
                            Component.componentMainImage(
                                context, ImagePath.LAUNDRY_FRONT_2_PASSWORD),
                            ...
                            CustomRichText
                              ...
                              TextSpan(
                                  ...
                                  style: textStyle_size_18_bold_color_yellow()),
                              TextSpan(
                                  text: LocaleUtil.getString(context,
                                      LocaleUtil.ENTER_PASSWORD_TEXT_3_ALT),
                                  style: textStyle_size_18_bold_color_white())
                            ]),
                            Column(
