...
class WasherFront1PasswordPage extends StatefulWidget {
  WasherFront1PasswordPage({Key? key}) : super(key: key);

  _WasherFront1PasswordPage createState() => _WasherFront1PasswordPage();
}

class _WasherFront1PasswordPage extends State<WasherFront1PasswordPage> {
                        ...
                        child: ListView(
                          ...
                          children: <Widget>[
                            Component.componentMainImage(
                                context, ImagePath.LAUNDRY_FRONT_1_PASSWORD),
