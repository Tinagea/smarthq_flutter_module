...
class WasherModel1GettingStartedFnpPage extends StatefulWidget {
  @override
  State createState() => _WasherModel1GettingStartedFnpPageState();
}

class _WasherModel1GettingStartedFnpPageState
    extends State<WasherModel1GettingStartedFnpPage>
                    ...
                    children: <Widget>[
                      Padding(
                        ...
                        child: Component.componentMainImage(
                            context,
                            ImagePath.LAUNDRY_FRONT_WASHER_1_REMOTE_WIFI),
                      ),
                              ...
                              children: [
                                TextSpan(
                                  text: LocaleUtil.getString(
                                      context,
                                      LocaleUtil
                                          .LAUNDRY_WASHER_FNP_FRONT_MODEL_1_DESCRIPTION_TEXT_1),
                                ...
                                TextSpan(
                                  text: LocaleUtil.getString(
                                      context,
                                      LocaleUtil
                                          .LAUNDRY_WASHER_FNP_FRONT_MODEL_1_DESCRIPTION_TEXT_2),
                                  style: textStyle_size_18_color_white(),
                                ),
                                WidgetSpan(
                                  alignment: PlaceholderAlignment.middle,
                                  child: SvgPicture.asset(
                                    ImagePath.LAUNDRY_FRONT_1_RIGHTMARK_ICON,
                                    height: 20,
                                    width: 20,
                                  ),
                                ),
                                TextSpan(
                                  text: LocaleUtil.getString(
                                      context,
                                      LocaleUtil
                                          .LAUNDRY_WASHER_FNP_FRONT_MODEL_1_DESCRIPTION_TEXT_3),
                                  style: textStyle_size_18_color_white(),
                                ),
                              ],
                            ),
  ...
  void _navigateToNextPage(BuildContext context) {
    Navigator.of(context).pushNamed(Routes.WASHER_MODEL_1_PASSWORD_FNP);
  }
