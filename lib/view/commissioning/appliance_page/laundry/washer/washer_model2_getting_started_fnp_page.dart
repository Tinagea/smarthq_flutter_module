...
class WasherModel2GettingStartedFnpPage extends StatefulWidget {
  @override
  State createState() => _WasherModel2GettingStartedFnpPageState();
}

class _WasherModel2GettingStartedFnpPageState
    extends State<WasherModel2GettingStartedFnpPage>
                    ...
                    children: <Widget>[
                      Padding(
                        ...
                        child: Component.componentMainImage(
                            context,
                            ImagePath.LAUNDRY_FRONT_WASHER_2_REMOTE_WIFI),
                      ),
                              ...
                              children: [
                                TextSpan(
                                  text: LocaleUtil.getString(
                                      context,
                                      LocaleUtil
                                          .LAUNDRY_WASHER_FNP_FRONT_MODEL_2_DESCRIPTION_TEXT_1),
                                ...
                                TextSpan(
                                  text: LocaleUtil.getString(
                                      context,
                                      LocaleUtil
                                          .LAUNDRY_WASHER_FNP_FRONT_MODEL_2_DESCRIPTION_TEXT_2),
                                  style: textStyle_size_18_color_white(),
                                ),
                                WidgetSpan(
                                    alignment: PlaceholderAlignment.middle,
                                    child: SvgPicture.asset(
                                      ImagePath.LAUNDRY_FRONT_1_GARMENT_ICON,
                                      height: 20,
                                      width: 20,
                                    )),
                                TextSpan(
                                  text: LocaleUtil.getString(
                                      context,
                                      LocaleUtil
                                          .LAUNDRY_WASHER_FNP_FRONT_MODEL_2_DESCRIPTION_TEXT_3),
                                  style: textStyle_size_18_color_white(),
                                ),
                                WidgetSpan(
                                  child: Icon(
                                ...
                                TextSpan(
                                  text: LocaleUtil.getString(
                                      context,
                                      LocaleUtil
                                          .LAUNDRY_WASHER_FNP_FRONT_MODEL_2_DESCRIPTION_TEXT_4),
                                  style: textStyle_size_18_color_white(),
                                ),
                              ],
                            ),
  ...
  void _navigateToNextPage(BuildContext context) {
    Navigator.of(context).pushNamed(Routes.WASHER_MODEL_2_PASSWORD_FNP);
  }
