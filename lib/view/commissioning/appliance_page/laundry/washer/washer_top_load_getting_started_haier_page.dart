...
class WasherTopLoadGettingStartedHaierPage extends StatefulWidget {
  @override
  State createState() => _WasherTopLoadGettingStartedHaierPageState();
}

class _WasherTopLoadGettingStartedHaierPageState
    extends State<WasherTopLoadGettingStartedHaierPage> with WidgetsBindingObserver {
  @override
                    ...
                    children: <Widget>[
                      Padding(
                        ...
                        child: Component.componentMainImage(context,
                            ImagePath.LAUNDRY_WASHER_TOP_1_HAIER),
                      ),
                              ...
                              children: [
                                TextSpan(
                                  text: LocaleUtil.getString(
                                      context,
                                      LocaleUtil
                                          .LAUNDRY_WASHER_HAIER_TOP_GETTING_STARTED_DESCRIPTION_1),
                                ...
                                TextSpan(
                                  text: LocaleUtil.getString(
                                      context,
                                      LocaleUtil
                                          .LAUNDRY_WASHER_HAIER_TOP_GETTING_STARTED_DESCRIPTION_2),
                                ...
                                TextSpan(
                                  text: LocaleUtil.getString(
                                      context,
                                      LocaleUtil
                                          .LAUNDRY_WASHER_HAIER_TOP_GETTING_STARTED_DESCRIPTION_3),
                                  style: textStyle_size_18_color_white(),
                                ),
                                TextSpan(
                                  text: LocaleUtil.getString(
                                      context,
                                      LocaleUtil
                                          .LAUNDRY_WASHER_HAIER_TOP_GETTING_STARTED_DESCRIPTION_4),
                                  style: textStyle_size_18_color_yellow(),
                                ),
                                TextSpan(
                                  text: LocaleUtil.getString(
                                      context,
                                      LocaleUtil
                                          .LAUNDRY_WASHER_HAIER_TOP_GETTING_STARTED_DESCRIPTION_5),
                                  style: textStyle_size_18_color_white(),
                                ),
                                WidgetSpan(
                                  child: Icon(
                                ...
                                TextSpan(
                                  text: LocaleUtil.getString(
                                      context,
                                      LocaleUtil
                                          .LAUNDRY_WASHER_HAIER_TOP_GETTING_STARTED_DESCRIPTION_6),
                                  style: textStyle_size_18_color_white(),
                                ),
                              ],
                            ),
  ...
  void _navigateToNextPage(BuildContext context) {
    Navigator.of(context).pushNamed(Routes.WASHER_TOP_LOAD_PASSWORD_HAIER);
  }
