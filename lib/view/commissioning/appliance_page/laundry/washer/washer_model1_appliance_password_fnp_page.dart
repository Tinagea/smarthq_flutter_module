...
class WasherModel1AppliancePasswordFnpPage extends StatefulWidget {
  WasherModel1AppliancePasswordFnpPage({Key? key}) : super(key: key);

  _WasherModel1AppliancePasswordFnpPageState createState() => _WasherModel1AppliancePasswordFnpPageState();
}

class _WasherModel1AppliancePasswordFnpPageState extends State<WasherModel1AppliancePasswordFnpPage> {
  var onTapRecognizer;
                    ...
                    child: ListView(
                      ...
                      children: <Widget>[
                        ...
                        Component.componentMainImage(context,
                            ImagePath.LAUNDRY_FRONT_1_PASSWORD_FNP),
                                    ...
                                    children: [
                                      TextSpan(
                                          text: LocaleUtil.getString(context,
                                              LocaleUtil.LAUNDRY_WASHER_FNP_FRONT_1_ENTER_PASSWORD_1),
                                          style: textStyle_size_18_color_white()
                                      ),
                                      TextSpan(
                                          text: LocaleUtil.getString(context,
                                              LocaleUtil.LAUNDRY_WASHER_FNP_FRONT_1_ENTER_PASSWORD_2),
                                          style: textStyle_size_18_color_yellow()
                                      ),
                                      TextSpan(
                                          text: LocaleUtil.getString(context,
                                              LocaleUtil.LAUNDRY_WASHER_FNP_FRONT_1_ENTER_PASSWORD_3),
                                          style: textStyle_size_18_color_white()
                                      )
                                    ]
                                )),
