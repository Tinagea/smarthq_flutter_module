...
class WasherTopLoadAppliancePasswordHaierPage extends StatefulWidget {
  WasherTopLoadAppliancePasswordHaierPage({Key? key}) : super(key: key);

  _WasherTopLoadAppliancePasswordHaierPageState createState() => _WasherTopLoadAppliancePasswordHaierPageState();
}

class _WasherTopLoadAppliancePasswordHaierPageState extends State<WasherTopLoadAppliancePasswordHaierPage> {
  var onTapRecognizer;
                    ...
                    child: ListView(
                      ...
                      children: <Widget>[
                        ...
                        Component.componentMainImage(context,
                            ImagePath.LAUNDRY_WASHER_TOP_1_PASSWORD_HAIER),
                                    ...
                                    children: [
                                      TextSpan(
                                          text: LocaleUtil.getString(context,
                                              LocaleUtil.LAUNDRY_WASHER_HAIER_FRONT_1_ENTER_PASSWORD_1),
                                          style: textStyle_size_18_color_white()
                                      ),
                                      TextSpan(
                                          text: LocaleUtil.getString(context,
                                              LocaleUtil.LAUNDRY_WASHER_HAIER_FRONT_1_ENTER_PASSWORD_2),
                                          style: textStyle_size_18_color_yellow()
                                      ),
                                      TextSpan(
                                          text: LocaleUtil.getString(context,
                                              LocaleUtil.LAUNDRY_WASHER_HAIER_FRONT_1_ENTER_PASSWORD_3),
                                          style: textStyle_size_18_color_white()
                                      )
                                    ]
                                )),
