...
class HearthOvenPasswordInfo extends StatefulWidget {
  @override
  _HearthOvenPasswordInfo createState() => _HearthOvenPasswordInfo();
}

class _HearthOvenPasswordInfo extends State<HearthOvenPasswordInfo> {
                    ...
                    children: [
                      Expanded(
                        child: ListView(
                          ...
                          shrinkWrap: true,
                          children: <Widget>[
                            Component.componentMainImage(context, ImagePath.HEARTH_OVEN_PASSWORD_INFO),
                            ...
                            CustomRichText.customSpanListTextBox(textSpanList: <TextSpan>[
                              TextSpan(text: LocaleUtil.getString(context, LocaleUtil.HEARTH_OVEN_APPLIANCE_PASSWORD_INFO), style: textStyle_size_18_color_white()),
                            ]),
                            BaseComponent.heightSpace(16.h),
                          Column(
                      ...
                      Component.componentBottomButton(
                          ...
                          onTapButton: () {
                            ...
                            if (_isAutoJoinSupport) {
                              ...
                              Navigator.of(context, rootNavigator: true).pushNamed(Routes.COMMON_MAIN_NAVIGATOR).then((_) => BlocProvider.of<BleCommissioningCubit>(context).restartContinuousScanForAppliance());
                            }
                          })
                    ],
                  );
