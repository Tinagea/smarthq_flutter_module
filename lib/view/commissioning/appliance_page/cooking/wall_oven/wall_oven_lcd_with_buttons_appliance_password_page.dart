...
class WallOvenLcdWithButtonsPasswordPage extends StatefulWidget {
  WallOvenLcdWithButtonsPasswordPage({Key? key}) : super(key: key);

  _WallOvenLcdWithButtonsPasswordPage createState() => _WallOvenLcdWithButtonsPasswordPage();
}

class _WallOvenLcdWithButtonsPasswordPage extends State<WallOvenLcdWithButtonsPasswordPage> {
                        ...
                        child: ListView(
                          ...
                          children: <Widget>[
                            Component.componentMainImage(context,
                                ImagePath.WALL_OVEN_TYPE_PRIMARY_2_PAGE_THREE_MAIN_IMAGE),
