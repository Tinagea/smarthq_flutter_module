...
class WallOvenPrimaryTypeTwoPageOneType1 extends StatefulWidget {
  @override
  _WallOvenPrimaryTypeTwoPageOneType1 createState() => _WallOvenPrimaryTypeTwoPageOneType1();
}

class _WallOvenPrimaryTypeTwoPageOneType1 extends State<WallOvenPrimaryTypeTwoPageOneType1>
      ...
      body: Component.componentCommissioningBody(
        ...
        <Widget>[
          ...
          Component.componentMainImage(
              context, ImagePath.WALL_OVEN_TYPE_PRIMARY_2_PAGE_ONE_TYPE_ONE),
            ...
            spanStringList: [
              TextSpan(
                  text: LocaleUtil.getString(
                      context, LocaleUtil.WALL_OVEN_TYPE_2_PRIMARY_DESC_05),
                  style: textStyle_size_18_color_white())
              ,TextSpan(
                  text: LocaleUtil.getString(
                      context, LocaleUtil.WALL_OVEN_TYPE_2_PRIMARY_DESC_06),
                  style: textStyle_size_18_color_yellow()),
              TextSpan(
                  text: LocaleUtil.getString(
                      context, LocaleUtil.WALL_OVEN_TYPE_2_PRIMARY_DESC_07),
                  style: textStyle_size_18_color_white()),
              WidgetSpan(
                  child: Icon(
                    Icons.wifi,
              ...
              TextSpan(
                  text: LocaleUtil.getString(
                      context, LocaleUtil.WALL_OVEN_TYPE_2_PRIMARY_DESC_08),
                  style: textStyle_size_18_color_white()),
            ],
