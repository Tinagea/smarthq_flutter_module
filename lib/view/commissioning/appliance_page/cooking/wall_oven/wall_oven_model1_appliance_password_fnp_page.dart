...
class WallOvenModel1AppliancePasswordFnpPage extends StatefulWidget {
  WallOvenModel1AppliancePasswordFnpPage({Key? key}) : super(key: key);

  _WallOvenModel1AppliancePasswordFnpPageState createState() => _WallOvenModel1AppliancePasswordFnpPageState();
}

class _WallOvenModel1AppliancePasswordFnpPageState extends State<WallOvenModel1AppliancePasswordFnpPage> {
  var onTapRecognizer;
                                    ...
                                    BlocProvider.of<BleCommissioningCubit>(context)
                                      ...
                                      if (bleState == 'on') {
                                        ...
                                        Navigator.of(context)
                                            .popUntil((route) => route.settings.name == Routes.WALL_OVEN_MODEL_1_STEP_1_FNP);
                                      } else {
