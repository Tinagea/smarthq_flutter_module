...
class WallOvenPrimaryTypeTwoPageOneType2 extends StatefulWidget {
  @override
  _WallOvenPrimaryTypeTwoPageOneType1 createState() => _WallOvenPrimaryTypeTwoPageOneType1();
}

class _WallOvenPrimaryTypeTwoPageOneType1 extends State<WallOvenPrimaryTypeTwoPageOneType2>
      ...
      body: Component.componentCommissioningBody(
        ...
        <Widget>[
          ...
          BlocListener<BleCommissioningCubit, BleCommissioningState>(
            ...
            listener: (context, state) {
              if (state.isSuccess == true) {
                ...
                globals.routeNameToBack = Routes.WALL_OVEN_PRIMARY_TYPE_2_PAGE_ONE_TWO;
          ...
          Component.componentMainImage(
              context, ImagePath.WALL_OVEN_TYPE_PRIMARY_2_PAGE_ONE_TYPE_TWO),
            ...
            spanStringList: [
              TextSpan(
                  text: LocaleUtil.getString(
                      context, LocaleUtil.WALL_OVEN_TYPE_2_PRIMARY_DESC_09),
                  style: textStyle_size_18_color_white())
              ,TextSpan(
                  text: LocaleUtil.getString(
                      context, LocaleUtil.WALL_OVEN_TYPE_2_PRIMARY_DESC_10),
                  style: textStyle_size_18_color_yellow()),
              TextSpan(
                  text: LocaleUtil.getString(
                      context, LocaleUtil.WALL_OVEN_TYPE_2_PRIMARY_DESC_11),
                  style: textStyle_size_18_color_white()),
              WidgetSpan(
                  child: Icon(
                    Icons.wifi,
              ...
              TextSpan(
                  text: LocaleUtil.getString(
                      context, LocaleUtil.WALL_OVEN_TYPE_2_PRIMARY_DESC_12),
                  style: textStyle_size_18_color_white()),
            ],
