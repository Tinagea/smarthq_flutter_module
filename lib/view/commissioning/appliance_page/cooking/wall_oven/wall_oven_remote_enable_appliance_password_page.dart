...
class PagePasswordWallOvenTypeTwoRemoteEnable extends StatefulWidget {
  PagePasswordWallOvenTypeTwoRemoteEnable({Key? key}) : super(key: key);

  _PagePasswordWallOvenTypeTwoRemoteEnable createState() => _PagePasswordWallOvenTypeTwoRemoteEnable();
}

class _PagePasswordWallOvenTypeTwoRemoteEnable extends State<PagePasswordWallOvenTypeTwoRemoteEnable> with WidgetsBindingObserver {
          ...
          appBar: CommonAppBar(
            ...
            leftBtnFunction: () {
              ...
              if (routingContext != null) {
                ...
                route.settings.name == Routes.WALL_OVEN_PRIMARY_TYPE_2_PAGE_TWO
                );
              }
            },
