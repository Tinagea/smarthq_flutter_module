...
class MicrowavePasswordInfo extends StatefulWidget {
  @override
  _MicrowavePasswordInfo createState() => _MicrowavePasswordInfo();
}

class _MicrowavePasswordInfo extends State<MicrowavePasswordInfo> {
                    ...
                    children: [
                      Expanded(
                        child: ListView(
                          ...
                          shrinkWrap: true,
                          children: <Widget>[
                            Component.componentMainImage(context, ImagePath.MICROWAVE_PASSWORD_INFO),
                            ...
                            CustomRichText.customSpanListTextBox(textSpanList: <TextSpan>[
                              TextSpan(text: LocaleUtil.getString(context, LocaleUtil.MICROWAVE_APPLIANCE_PASSWORD_INFO), style: textStyle_size_18_color_white()),
                            ]),
                            BaseComponent.heightSpace(16.h),
                          ...
                          onTapButton: () {
                            ...
                            if (_isAutoJoinSupport) {
                              ...
                              Navigator.of(context, rootNavigator: true).pushNamed(Routes.COMMON_MAIN_NAVIGATOR)
                                  .then((_) => BlocProvider.of<BleCommissioningCubit>(context).restartContinuousScanForAppliance());
                            }
                          })
                    ],
                  );
