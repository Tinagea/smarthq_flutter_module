...
class HoodCommissioningModel2Step2 extends StatefulWidget {

  @override
  State createState() => _HoodCommissioningModel2Step2();

}


class _HoodCommissioningModel2Step2 extends State<HoodCommissioningModel2Step2> with WidgetsBindingObserver {
                  ...
                  BlocListener<BleCommissioningCubit, BleCommissioningState>(
                    ...
                    listener: (context, state) {
                      ...
                      if (state.isSuccess == true) {
                        ...
                        globals.routeNameToBack = Routes.HOOD_DESCRIPTION2_MODEL2;
                        Navigator.of(context).pushNamed(Routes.HOOD_COMMISSIONING_ENTER_PASSWORD);
                      }
                    },
                    child: Container(),
                  ),
                    ...
                    child: ListView(
                      children: <Widget>[
                        ...
                        CustomRichText.addWifiTextBox(
                            spanStringList: [
                              TextSpan(
                                  text: LocaleUtil.getString(context, LocaleUtil.WIFI_STEPS_TEXT_2_1),
                                  style: textStyle_size_18_color_white()),
                              TextSpan(
                                  text: ' light ',
                                  style: textStyle_size_18_color_yellow()),
                              TextSpan(
                                  text: LocaleUtil.getString(context, LocaleUtil.WIFI_STEPS_TEXT_2_2),
                                  style: textStyle_size_18_color_white()),
                              TextSpan(
                                  text: ' Chief Connect ',
                                  style: textStyle_size_18_color_yellow()),
                              TextSpan(
                                  text: LocaleUtil.getString(context, LocaleUtil.WIFI_STEPS_TEXT_2_3),
                                  style: textStyle_size_18_color_white()),
                              ...
                              TextSpan(
                                  text: LocaleUtil.getString(context, LocaleUtil.WIFI_STEPS_TEXT_2_4),
                                  style: textStyle_size_18_color_white()),
                              TextSpan(
                                  text: ' WiFi ',
                                  style: textStyle_size_18_color_yellow()),
                              TextSpan(
                                  text: LocaleUtil.getString(context, LocaleUtil.WIFI_STEPS_TEXT_2_5),
                                  style: textStyle_size_18_color_white())
                            ],
                  ...
                  BlocBuilder<CommissioningCubit, CommissioningState>(
                    ...
                    builder: (context, state) {
                      return Component.componentBottomButton(
                          ...
                          onTapButton: () {
                            geaLog.debug("HoodCommissioningModel2Step2 on tap");
                            BlocProvider.of<BleCommissioningCubit>(context)
                                .actionBleStartPairingAction2(ApplianceType.HOOD,
                                    () {
                                  globals.routeNameToBack = Routes.HOOD_DESCRIPTION2_MODEL2;
                                  Navigator.of(context).pushNamed(Routes.HOOD_COMMISSIONING_ENTER_PASSWORD);
