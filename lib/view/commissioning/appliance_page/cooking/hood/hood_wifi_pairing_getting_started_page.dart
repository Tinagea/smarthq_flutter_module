...
class HoodCommissioningModel1Step2 extends StatefulWidget {

  @override
  State createState() => _HoodCommissioningModel1Step2();

}


class _HoodCommissioningModel1Step2 extends State<HoodCommissioningModel1Step2> with WidgetsBindingObserver {
                      ...
                      children: <Widget>[
                        ...
                        BlocListener<BleCommissioningCubit, BleCommissioningState>(
                          ...
                          listener: (context, state) {
                            ...
                            if (state.isSuccess == true) {
                              ...
                              globals.routeNameToBack = Routes.HOOD_DESCRIPTION2_MODEL1;
                              Navigator.of(context).pushNamed(Routes.HOOD_DESCRIPTION3_MODEL1);
                            }
                          },
                          child: Container(),
                        ),
                        Component.componentMainImage(context,
                            ImagePath.HOOD_IMAGE4),
                        ...
                        CustomRichText.customSpanListTextBox(
                          textSpanList: <TextSpan>[
                            TextSpan(
                                text: LocaleUtil.getString(context, LocaleUtil.WIFI_STEPS_TEXT_1),
                                style: textStyle_size_18_color_white()),
                            TextSpan(
                                text: ' Low/WiFi Pairing ',
                                style: textStyle_size_18_color_yellow()),
                            TextSpan(
                                text: LocaleUtil.getString(context, LocaleUtil.WIFI_STEPS_TEXT_1_2),
                                style: textStyle_size_18_color_white()),
                            TextSpan(
                                text: ' Wi-Fi ',
                                style: textStyle_size_18_color_yellow()),
                            TextSpan(
                                text: LocaleUtil.getString(context, LocaleUtil.WIFI_STEPS_TEXT_1_3),
                                style: textStyle_size_18_color_white()),
                          ],
                        ),
                        BaseComponent.heightSpace(16.h),
                  ...
                  BlocBuilder<CommissioningCubit, CommissioningState>(
                    ...
                    builder: (context, state) {
                      return Component.componentBottomButton(
                          ...
                          onTapButton: () {
                            geaLog.debug("HoodCommissioningModel1Step2 on tap");
