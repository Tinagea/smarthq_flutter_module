...
class PageCooktopElectricDescription extends StatefulWidget {
  @override
  State createState() => _PageCooktopElectricDescription();
}


class _PageCooktopElectricDescription extends State<PageCooktopElectricDescription> with WidgetsBindingObserver {
                    ...
                    child: ListView(
                      children: <Widget>[
                        ...
                        BlocListener<BleCommissioningCubit, BleCommissioningState>(
                          ...
                          listener: (context, state) {
                            if (state.isSuccess == true) {
                              ...
                              globals.routeNameToBack = Routes.COOKTOP_ELECTRIC_DESCRIPTION;
                              Navigator.of(context).pushNamed(Routes.COOKTOP_APPLIANCE_INFO_ELECTRIC);
                            }
                          },
                          child: Container(),
                        ),
                        BaseComponent.heightSpace(40.h),
                        Component.componentMainImageWithPadding(context,
                            ImagePath.COOKTOP_ELECTRIC_DESCRIPTION,
                        ...
                        CustomRichText.addWifiTextBox(
                          spanStringList: [
                            TextSpan(
                              text: LocaleUtil.getString(context, LocaleUtil.COOKTOP_ELECTRIC_DESCRIPTION_TEXT_1),
                              style: textStyle_size_18_color_white()),
                            TextSpan(
                              text: LocaleUtil.getString(context, LocaleUtil.COOKTOP_ELECTRIC_DESCRIPTION_TEXT_2),
                              style: textStyle_size_18_color_yellow()),
                            TextSpan(
                              text: LocaleUtil.getString(context, LocaleUtil.COOKTOP_ELECTRIC_DESCRIPTION_TEXT_3),
                              style: textStyle_size_18_color_white()),
                            WidgetSpan(
                              child: Icon(
                                Icons.wifi,
                            ...
                            TextSpan(
                              text: LocaleUtil.getString(context, LocaleUtil.COOKTOP_ELECTRIC_DESCRIPTION_TEXT_4),
                              style: textStyle_size_18_color_white())
                          ],
                            ...
                            onTapButton: () {
                              BlocProvider.of<BleCommissioningCubit>(context)
                                  ...
                                  globals.routeNameToBack =
                                      Routes.COOKTOP_ELECTRIC_DESCRIPTION;
                                  Navigator.of(context).pushNamed(
                                      Routes.COOKTOP_APPLIANCE_INFO_ELECTRIC);
