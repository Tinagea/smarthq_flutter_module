...
class PageCooktopInductionDescription extends StatefulWidget {
  @override
  State createState() => _PageCooktopInductionDescription();
}


class _PageCooktopInductionDescription extends State<PageCooktopInductionDescription> with WidgetsBindingObserver {
                    ...
                    child: ListView(
                      children: <Widget>[
                        ...
                        Component.componentMainImage(context,
                            ImagePath.COOKTOP_INDUCTION_DESCRIPTION),
                        BaseComponent.heightSpace(40.h),
                        ...
                        CustomRichText.customSpanListTextBox(
                            textSpanList: <TextSpan>[
                              TextSpan(
                                  text: LocaleUtil.getString(context,
                                      LocaleUtil.COOKTOP_INDCUTION_DESCRIPTION_TEXT_1),
                                  style: textStyle_size_18_color_white()),
                              TextSpan(
                                  text: LocaleUtil.getString(context,
                                      LocaleUtil.COOKTOP_INDCUTION_DESCRIPTION_TEXT_2),
                                  style: textStyle_size_18_color_yellow()),
                              TextSpan(
                                  text: LocaleUtil.getString(context,
                                      LocaleUtil.COOKTOP_INDCUTION_DESCRIPTION_TEXT_3),
                                  style: textStyle_size_18_color_white()),
                            ],
