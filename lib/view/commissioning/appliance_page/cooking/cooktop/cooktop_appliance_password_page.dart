...
class PageCooktopPasswordInfo extends StatefulWidget {
  @override
  _PageCooktopPasswordInfo createState() => _PageCooktopPasswordInfo();
}

class _PageCooktopPasswordInfo extends State<PageCooktopPasswordInfo>{
                    ...
                    children: [
                      Expanded(
                        child: ListView(
                          ...
                          shrinkWrap: true,
                          children: <Widget>[
                            Component.componentMainImage(context, ImagePath.COOKTOP_INDUCTION_PASSWORD_INFO),
                            ...
                            CustomRichText.customSpanListTextBox(textSpanList: <TextSpan>[
                              TextSpan(text: LocaleUtil.getString(context, LocaleUtil.ENTER_THE_PASSWORD_FOUND_ON_THE_LABEL), style: textStyle_size_18_color_white()),
                            ]),
                            BaseComponent.heightSpace(16.h),
                            Column(
