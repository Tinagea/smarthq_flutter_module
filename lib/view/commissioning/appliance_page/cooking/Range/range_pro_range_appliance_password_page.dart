...
class RangeProRangePasswordInfo extends StatefulWidget {
  @override
  _RangeProRangePasswordInfo createState() => _RangeProRangePasswordInfo();
}

class _RangeProRangePasswordInfo extends State<RangeProRangePasswordInfo> {
                    ...
                    children: [
                      Expanded(
                        child: ListView(
                          ...
                          shrinkWrap: true,
                          children: <Widget>[
                            Component.componentMainImage(context, ImagePath.RANGE_PRO_RANGE_PASSWORD_INFO),
