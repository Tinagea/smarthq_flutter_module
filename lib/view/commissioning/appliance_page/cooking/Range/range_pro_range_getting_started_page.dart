...
class RangeProRangeDescription extends StatefulWidget {

  @override
  State createState() => _RangeProRangeDescription();

}


class _RangeProRangeDescription extends State<RangeProRangeDescription> with WidgetsBindingObserver {
                    ...
                    child: ListView(
                      children: <Widget>[
                        ...
                        BlocListener<BleCommissioningCubit, BleCommissioningState>(
                          ...
                          listener: (context, state) {
                            if (state.isSuccess == true) {
                              ...
                              globals.routeNameToBack = Routes.RANGE_PRO_RANGE_DESCRIPTION;
                              Navigator.of(context).pushNamed(Routes.RANGE_PRO_RANGE_PASSWORD_INFO);
                            }
                          },
                          child: Container(),
                        ),
                        ...
                        Component.componentMainImage(context,
                            ImagePath.RANGE_PRO_RANGE_DESCRIPTION),
                        BaseComponent.heightSpace(40.h),
                        ...
                        CustomRichText.addWifiTextBox(
                            spanStringList: [
                              TextSpan(
                                  text: LocaleUtil.getString(context,
                                      LocaleUtil.RANGE_PRO_RANGE_DESCRIPTION_TEXT_1),
                                  style: textStyle_size_18_color_white()),
                              TextSpan(
                                  text: LocaleUtil.getString(context,
                                      LocaleUtil.RANGE_PRO_RANGE_DESCRIPTION_TEXT_2),
                                  style: textStyle_size_18_color_yellow()),
                              TextSpan(
                                  text: LocaleUtil.getString(context,
                                      LocaleUtil.RANGE_PRO_RANGE_DESCRIPTION_TEXT_3),
                                  style: textStyle_size_18_color_white()),
                              TextSpan(
                                  text: LocaleUtil.getString(context,
                                      LocaleUtil.RANGE_PRO_RANGE_DESCRIPTION_TEXT_4),
                                  style: textStyle_size_18_color_yellow()),
                              TextSpan(
                                  text: LocaleUtil.getString(context,
                                      LocaleUtil.RANGE_PRO_RANGE_DESCRIPTION_TEXT_5),
                                  style: textStyle_size_18_color_white()),
                              TextSpan(
                                  text: LocaleUtil.getString(context,
                                      LocaleUtil.RANGE_PRO_RANGE_DESCRIPTION_TEXT_6),
                                  style: textStyle_size_18_color_yellow()),
                            ],
