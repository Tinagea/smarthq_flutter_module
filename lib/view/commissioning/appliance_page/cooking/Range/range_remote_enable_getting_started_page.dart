...
class RangeRemoteEnableDescription extends StatefulWidget {
  @override
  State createState() => _RangeRemoteEnableDescription();
}

class _RangeRemoteEnableDescription extends State<RangeRemoteEnableDescription> with WidgetsBindingObserver {
                    ...
                    child: ListView(
                      children: <Widget>[
                        ...
                        BlocListener<BleCommissioningCubit, BleCommissioningState>(
                          ...
                          listener: (context, state) {
                            if (state.isSuccess == true) {
                              ...
                              globals.navigatorNameToBack = Routes.RANGE_MAIN_NAVIGATOR;
                              globals.routeNameToBack = Routes.RANGE_REMOTE_ENABLE_DESCRIPTION;
                              Navigator.of(context).pushNamed(Routes.RANGE_REMOTE_ENABLE_APPLIANCE_INFO);
                            }
                          },
                          child: Container(),
                        ),
                        ...
                        Component.componentMainImage(context,
                            ImagePath.RANGE_REMOTE_ENABLE_DESCRIPTION),
                        BaseComponent.heightSpace(40.h),
                        ...
                        CustomRichText.addWifiTextBox(
                            spanStringList: [
                              TextSpan(
                                  text: LocaleUtil.getString(context,
                                      LocaleUtil.RANGE_REMOTE_ENABLE_DESCRIPTION_TEXT_1),
                                  style: textStyle_size_18_color_white()),
                              TextSpan(
                                  text: LocaleUtil.getString(context,
                                      LocaleUtil.RANGE_REMOTE_ENABLE_DESCRIPTION_TEXT_2),
                                  style: textStyle_size_18_color_yellow()),
                              TextSpan(
                                  text: LocaleUtil.getString(context,
                                      LocaleUtil.RANGE_REMOTE_ENABLE_DESCRIPTION_TEXT_3),
                                  style: textStyle_size_18_color_white()),
                              WidgetSpan(
                                child: Icon(
                                  Icons.wifi,
                              ...
                              TextSpan(
                                  text: LocaleUtil.getString(context,
                                      LocaleUtil.RANGE_REMOTE_ENABLE_DESCRIPTION_TEXT_4),
                                  style: textStyle_size_18_color_white()),
                            ],
