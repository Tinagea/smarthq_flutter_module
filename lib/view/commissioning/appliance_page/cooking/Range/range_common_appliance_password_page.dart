...
class RangeTypeTwoCommonPasswordInfo extends StatefulWidget {
  @override
  _RangeTypeTwoCommonPasswordInfo createState() => _RangeTypeTwoCommonPasswordInfo();
}

class _RangeTypeTwoCommonPasswordInfo extends State<RangeTypeTwoCommonPasswordInfo> {
                    ...
                    children: [
                      Expanded(
                        child: ListView(
                          ...
                          shrinkWrap: true,
                          children: <Widget>[
                            Component.componentMainImage(context, ImagePath.RANGE_HAIER_KNOB_APPLIANCE_PASSWORD_INFO),
                            ...
                            CustomRichText.customSpanListTextBox(textSpanList: <TextSpan>[
                              TextSpan(text: LocaleUtil.getString(context, LocaleUtil.PASSWORD_ON_CONNECTED_APPLIANCE_LABEL), style: textStyle_size_18_color_white()),
                            ]),
                            BaseComponent.heightSpace(16.h),
                            Column(
