...
class RangeHairAppKnobApplianceInfo extends StatefulWidget {
  RangeHairAppKnobApplianceInfo({Key? key}) : super(key: key);

  _RangeHairAppKnobApplianceInfo createState() => _RangeHairAppKnobApplianceInfo();
}

class _RangeHairAppKnobApplianceInfo extends State<RangeHairAppKnobApplianceInfo> {
  @override
            ...
            Component.componentBottomButton(
                ...
                onTapButton: () {
                  Navigator.of(context)
                      .pushNamed(Routes.RANGE_HAIER_KNOB_APPLIANCE_PASSWORD_INFO);
                }
            ),
          ),
        )
