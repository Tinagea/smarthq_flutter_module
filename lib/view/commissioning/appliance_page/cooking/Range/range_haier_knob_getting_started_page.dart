...
class RangeHairAppKnobDescription extends StatefulWidget {

  @override
  State createState() => _RangeHairAppKnobDescription();

}


class _RangeHairAppKnobDescription extends State<RangeHairAppKnobDescription> with WidgetsBindingObserver {
                    ...
                    child: ListView(
                      children: <Widget>[
                        ...
                        BlocListener<BleCommissioningCubit, BleCommissioningState>(
                          ...
                          listener: (context, state) {
                            if (state.isSuccess == true) {
                              ...
                              globals.routeNameToBack = Routes.RANGE_HAIER_KNOB_DESCRIPTION;
                              Navigator.of(context).pushNamed(Routes.RANGE_HAIER_KNOB_APPLIANCE_INFO);
                            }
                          },
                          child: Container(),
                        ),
                        ...
                        Component.componentMainImage(context,
                            ImagePath.RANGE_HAIER_KNOB_DESCRIPTION),
                        BaseComponent.heightSpace(40.h),
                        ...
                        CustomRichText.addWifiTextBox(
                            spanStringList: [
                              TextSpan(
                                  text: LocaleUtil.getString(context,
                                      LocaleUtil.RANGE_HAIER_KNOB_DESCRIPTION_TEXT_1),
                                  style: textStyle_size_18_color_white()),
                              TextSpan(
                                  text: LocaleUtil.getString(context,
                                      LocaleUtil.RANGE_HAIER_KNOB_DESCRIPTION_TEXT_2),
                                  style: textStyle_size_18_color_yellow()),
                              TextSpan(
                                  text: LocaleUtil.getString(context,
                                      LocaleUtil.RANGE_HAIER_KNOB_DESCRIPTION_TEXT_3),
                                  style: textStyle_size_18_color_white()),
                            ],
