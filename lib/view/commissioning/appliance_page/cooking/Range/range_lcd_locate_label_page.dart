...
class RangeLcdApplianceInfo extends StatefulWidget {
  RangeLcdApplianceInfo({Key? key}) : super(key: key);

  _RangeLcdApplianceInfo createState() => _RangeLcdApplianceInfo();
}

class _RangeLcdApplianceInfo extends State<RangeLcdApplianceInfo> {
  @override
            ...
            Component.componentBottomButton(
                ...
                onTapButton: () {
                  Navigator.of(context)
                      .pushNamed(Routes.RANGE_LCD_PASSWORD_INFO_2);
                }
            ),
          ),
        )
