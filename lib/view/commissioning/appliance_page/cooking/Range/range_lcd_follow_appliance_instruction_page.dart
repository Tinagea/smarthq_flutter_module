...
class RangeLcdFollowApplianceInstructionPage extends StatefulWidget {
  @override
  _RangeLcdFollowApplianceInstructionPage createState() => _RangeLcdFollowApplianceInstructionPage();
}

class _RangeLcdFollowApplianceInstructionPage extends State<RangeLcdFollowApplianceInstructionPage> with WidgetsBindingObserver {
  @override
  void initState() {
    super.initState();
