...
class RangeLcdPasswordInfo extends StatefulWidget {
  final bool isFirstTimeShown;
  RangeLcdPasswordInfo({
    Key? key, required this.isFirstTimeShown,
  }) : super(key: key);

  _RangeLcdPasswordInfo createState() => _RangeLcdPasswordInfo(isFirstTimeShown: this.isFirstTimeShown);
}

class _RangeLcdPasswordInfo extends State<RangeLcdPasswordInfo> with WidgetsBindingObserver{
  bool _isFirstTimeShown = false;

  _RangeLcdPasswordInfo({bool isFirstTimeShown = false}) {
                      ...
                      children: [
                        Expanded(
                          child: ListView(
                            ...
                            shrinkWrap: true,
                            children: <Widget>[
                              Component.componentMainImage(context, ImagePath.RANGE_LCD_PASSWORD_INFO),
                              ...
                              return Component.componentBottomButton(
                                  ...
                                  onTapButton: () {
                                    if (_isFirstTimeShown &&
                                        (_passwordTextFieldStatus == TextFieldStatus.empty) &&
                                        (_geModuleTextFieldStatus == TextFieldStatus.empty)) {
                                      Navigator.of(context).pushNamed(Routes.RANGE_LCD_DESCRIPTION);
