...
class RangeWifiConnectDescription extends StatefulWidget {
  @override
  State createState() => _RangeWifiConnectDescription();

}


class _RangeWifiConnectDescription extends State<RangeWifiConnectDescription> with WidgetsBindingObserver {
                    ...
                    child: ListView(
                      children: <Widget>[
                        ...
                        BlocListener<BleCommissioningCubit, BleCommissioningState>(
                          ...
                          listener: (context, state) {
                            if (state.isSuccess == true) {
                              ...
                              globals.routeNameToBack = Routes.RANGE_WIFI_CONNECT_DESCRIPTION;
                        ...
                        Component.componentMainImage(context,
                            ImagePath.RANGE_WIFI_CONNECT_DESCRIPTION),
                        BaseComponent.heightSpace(40.h),
                        ...
                        CustomRichText.addWifiTextBox(
                            spanStringList: [
                              TextSpan(
                                  text: LocaleUtil.getString(context,
                                      LocaleUtil.RANGE_WIFI_CONNECT_DESCRIPTION_TEXT_1),
                                  style: textStyle_size_18_color_white()),
                              TextSpan(
                                  text: LocaleUtil.getString(context,
                                      LocaleUtil.RANGE_WIFI_CONNECT_DESCRIPTION_TEXT_2),
                                  style: textStyle_size_18_color_yellow()),
                              TextSpan(
                                  text: LocaleUtil.getString(context,
                                      LocaleUtil.RANGE_WIFI_CONNECT_DESCRIPTION_TEXT_3),
                                  style: textStyle_size_18_color_white()),
                              WidgetSpan(
                                child: Icon(
                                  Icons.wifi,
                              ...
                              TextSpan(
                                  text: LocaleUtil.getString(context,
                                      LocaleUtil.RANGE_WIFI_CONNECT_DESCRIPTION_TEXT_4),
                                  style: textStyle_size_18_color_white()),
                            ],
