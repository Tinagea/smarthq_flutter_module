...
class WaterFilterDescription extends StatefulWidget {
  const WaterFilterDescription({Key? key}) : super(key: key);
  @override
  State createState() => _WaterFilterDescription();
}

class _WaterFilterDescription extends State<WaterFilterDescription>
                    ...
                    child: ListView(
                      children: <Widget>[
                        ...
                        BlocListener<BleCommissioningCubit, BleCommissioningState>(
                          ...
                          listener: (context, state) {
                            ...
                            if (state.isSuccess == true) {
                              ...
                              globals.routeNameToBack = Routes.WATER_FILTER_DESCRIPTION;
                              Navigator.of(context).pushNamed(Routes.WATER_FILTER_APPLIANCE_INFO);
                            }
                          },
                          child: Container(),
                        ),
                        ...
                        Component.componentMainImage(
                            context, ImagePath.WATER_FILTER_DESCRIPTION),
                          ...
                          spanStringList: [
                            TextSpan(
                                text: LocaleUtil.getString(
                                    context,
                                    LocaleUtil
                                        .WATER_FILTER_DESCRIPTION_TEXT_1),
                                style: textStyle_size_18_color_white()),
                            TextSpan(
                                text: LocaleUtil.getString(
                                    context, LocaleUtil.WATER_FILTER_DESCRIPTION_TEXT_2),
                                style: textStyle_size_18_color_yellow()),
                            TextSpan(
                                text: LocaleUtil.getString(
                                    context, LocaleUtil.WATER_FILTER_DESCRIPTION_TEXT_3),
                                style: textStyle_size_18_color_white()),
                          ],
                        ...
                        return Component.componentBottomButton(
                            ...
                            onTapButton: () {
                              BlocProvider.of<BleCommissioningCubit>(context)
                                  .actionBleStartPairingAction2(ApplianceType.POE_WATER_FILTER, () {
                                    geaLog.debug("WaterFilterDescription on tap");
                                    globals.routeNameToBack = Routes.WATER_FILTER_DESCRIPTION;
                                    Navigator.of(context).pushNamed(Routes.WATER_FILTER_APPLIANCE_INFO);
