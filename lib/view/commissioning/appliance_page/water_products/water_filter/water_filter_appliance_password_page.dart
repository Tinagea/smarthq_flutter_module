...
class WaterFilterPasswordInfo extends StatefulWidget {
  WaterFilterPasswordInfo({Key? key}) : super(key: key);

  _WaterFilterPasswordInfo createState() => _WaterFilterPasswordInfo();
}

class _WaterFilterPasswordInfo extends State<WaterFilterPasswordInfo> {
                        ...
                        child: ListView(
                          ...
                          children: <Widget>[
                            Component.componentMainImage(
                                context, ImagePath.WATER_FILTER_PASSWORD_INFO),
