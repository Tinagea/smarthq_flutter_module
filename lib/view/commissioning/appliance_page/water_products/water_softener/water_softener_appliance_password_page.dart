...
class WaterSoftenerPasswordInfo extends StatefulWidget {
  WaterSoftenerPasswordInfo({Key? key}) : super(key: key);

  _WaterSoftenerPasswordInfo createState() => _WaterSoftenerPasswordInfo();
}

class _WaterSoftenerPasswordInfo extends State<WaterSoftenerPasswordInfo> {
                        ...
                        child: ListView(
                          ...
                          children: <Widget>[
                            Component.componentMainImage(context,
                                ImagePath.WATER_SOFTENER_PASSWORD_INFO),
