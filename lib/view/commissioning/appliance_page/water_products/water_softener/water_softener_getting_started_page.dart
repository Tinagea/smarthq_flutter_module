...
class WaterSoftenerDescription extends StatefulWidget {
  const WaterSoftenerDescription({Key? key}) : super(key: key);
  @override
  State createState() => _WaterSoftenerDescription();
}

class _WaterSoftenerDescription extends State<WaterSoftenerDescription>
                        ...
                        BlocListener<BleCommissioningCubit, BleCommissioningState>(
                          ...
                          listener: (context, state) {
                            ...
                            if (state.isSuccess == true) {
                              ...
                              globals.routeNameToBack = Routes.WATER_SOFTENER_DESCRIPTION;
                              Navigator.of(context).pushNamed(Routes.WATER_SOFTENER_APPLIANCE_INFO);
                            }
                          },
                          child: Container(),
                        ),
                        Component.componentMainImage(
                            context, ImagePath.WATER_SOFTENER_DESCRIPTION),
                          ...
                          spanStringList: [
                            TextSpan(
                                text: LocaleUtil.getString(
                                    context,
                                    LocaleUtil
                                        .WATER_SOFTENER_DESCRIPTION_TEXT_1),
                                style: textStyle_size_18_color_white()),
                            TextSpan(
                                text: LocaleUtil.getString(
                                    context, LocaleUtil.WATER_SOFTENER_DESCRIPTION_TEXT_2),
                                style: textStyle_size_18_color_yellow()),
                            TextSpan(
                                text: LocaleUtil.getString(
                                    context, LocaleUtil.WATER_SOFTENER_DESCRIPTION_TEXT_3),
                                style: textStyle_size_18_color_white()),
                        ...
                        return Component.componentBottomButton(
                            ...
                            onTapButton: () {
                              BlocProvider.of<BleCommissioningCubit>(context)
                                  .actionBleStartPairingAction2(ApplianceType.WATER_SOFTENER, () {
                                    geaLog.debug("WaterSoftenerDescription on tap");
                                    globals.routeNameToBack = Routes.WATER_SOFTENER_DESCRIPTION;
                                    Navigator.of(context).pushNamed(Routes.WATER_SOFTENER_APPLIANCE_INFO);
