...
class WaterHeaterDescription extends StatefulWidget {
  const WaterHeaterDescription({Key? key}) : super(key: key);
  @override
  State createState() => _WaterHeaterDescription();
}

class _WaterHeaterDescription extends State<WaterHeaterDescription>
                      ...
                      children: <Widget>[
                        ...
                        BlocListener<BleCommissioningCubit, BleCommissioningState>(
                          ...
                          listener: (context, state) {
                            ...
                            if (state.isSuccess == true) {
                              ...
                              globals.routeNameToBack = Routes.WATER_HEATER_DESCRIPTION;
                              Navigator.of(context).pushNamed(Routes.WATER_HEATER_APPLIANCE_INFO);
                            }
                          },
                          child: Container(),
                        ),
                        Component.componentMainImage(
                            context, ImagePath.WATER_HEATER_DESCRIPTION),
                          ...
                          spanStringList: [
                            TextSpan(
                                text: LocaleUtil.getString(
                                    context,
                                    LocaleUtil
                                        .WATER_HEATER_DESCRIPTION_TEXT_1),
                            ...
                            TextSpan(
                                text: LocaleUtil.getString(
                                    context, LocaleUtil.WATER_HEATER_DESCRIPTION_TEXT_2),
                            ...
                            TextSpan(
                                text: LocaleUtil.getString(
                                    context, LocaleUtil.WATER_HEATER_DESCRIPTION_TEXT_3),
                                style: textStyle_size_18_color_white()),
                            WidgetSpan(
                              child: Icon(
                                Icons.wifi,
                            ...
                            TextSpan(
                                text: LocaleUtil.getString(
                                    context, LocaleUtil.WATER_HEATER_DESCRIPTION_TEXT_4),
                                style: textStyle_size_18_color_yellow()),
                        ...
                        Component.componentDescriptionTextWithLinkActionLabel(
                          contents: LocaleUtil.getString(context,
                              LocaleUtil.IT_DOESNT_WORK_YOU_MIGHT_NEED)!,
                          contentsForLink: LocaleUtil.getString(context,
                              LocaleUtil.CONNECT_PLUS)!,
                          onTapButton:() {
                            Navigator.of(context, rootNavigator: true).pushNamed(Routes.CONNECT_PLUS_MAIN_NAVIGATOR,arguments: ScreenArgs(ApplianceType.WATER_HEATER));
                          },
                        ...
                        return Component.componentBottomButton(
                            ...
                            onTapButton: () {
                              BlocProvider.of<BleCommissioningCubit>(context)
                                  .actionBleStartPairingAction2(ApplianceType.WATER_HEATER, () {
                                    geaLog.debug("WaterHeaterDescription on tap");
                                    globals.routeNameToBack = Routes.WATER_HEATER_DESCRIPTION;
                                    Navigator.of(context).pushNamed(Routes.WATER_HEATER_APPLIANCE_INFO);
