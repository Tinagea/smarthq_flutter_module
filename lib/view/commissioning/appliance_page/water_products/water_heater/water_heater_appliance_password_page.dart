...
class WaterHeaterPasswordInfo extends StatefulWidget {
  WaterHeaterPasswordInfo({Key? key}) : super(key: key);

  _WaterHeaterPasswordInfo createState() => _WaterHeaterPasswordInfo();
}

class _WaterHeaterPasswordInfo extends State<WaterHeaterPasswordInfo> {
                        ...
                        child: ListView(
                          ...
                          children: <Widget>[
                            Component.componentMainImage(
                                context, ImagePath.WATER_HEATER_PASSWORD_INFO),
