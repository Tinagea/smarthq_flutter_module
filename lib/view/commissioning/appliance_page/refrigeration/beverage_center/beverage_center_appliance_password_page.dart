...
class PageBeverageCenterPassword extends StatefulWidget {
  PageBeverageCenterPassword({Key? key}) : super(key: key);

  _PageBeverageCenterPassword createState() => _PageBeverageCenterPassword();
}

class _PageBeverageCenterPassword extends State<PageBeverageCenterPassword> {
