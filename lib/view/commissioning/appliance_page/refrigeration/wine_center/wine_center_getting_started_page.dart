...
class PageWineCenterDescription extends StatefulWidget {
  PageWineCenterDescription({Key? key}) : super(key: key);

  _PageWineCenterDescription createState() => _PageWineCenterDescription();
}

class _PageWineCenterDescription extends State<PageWineCenterDescription> with WidgetsBindingObserver {
              ...
              BlocListener<BleCommissioningCubit, BleCommissioningState>(
                ...
                listener: (context, state) {
                  ...
                  if (state.isSuccess == true) {
                    ...
                    globals.routeNameToBack = Routes.WINE_CENTER_DESCRIPTION;
                    Navigator.of(context).pushNamed(Routes.WINE_CENTER_APPLIANCE_INFO);
                  }
                },
                child: Container(),
              ),
              Component.componentMainImage(context, ImagePath.WINE_CENTER_DESCRIPTION),
              ...
              CustomRichText.addWifiTextBox(spanStringList: [
                TextSpan(
                    text: LocaleUtil.getString(context,
                        LocaleUtil.WINE_CENTER_DESCRIPTION_TEXT_1),
                    style: textStyle_size_18_color_white()),
                TextSpan(
                    text: LocaleUtil.getString(context,
                        LocaleUtil.WINE_CENTER_DESCRIPTION_TEXT_2),
                    style: textStyle_size_18_color_yellow()),
                TextSpan(
                    text: LocaleUtil.getString(context,
                        LocaleUtil.WINE_CENTER_DESCRIPTION_TEXT_3),
                    style: textStyle_size_18_color_white()),
                TextSpan(
                    text: LocaleUtil.getString(context,
                        LocaleUtil.WINE_CENTER_DESCRIPTION_TEXT_4),
                    style: textStyle_size_18_color_white()),
                WidgetSpan(
                  child: Icon(
                    Icons.wifi,
                ...
                TextSpan(
                    text: LocaleUtil.getString(context,
                        LocaleUtil.WINE_CENTER_DESCRIPTION_TEXT_5),
                    style: textStyle_size_18_color_white()),
                ...
                return Component.componentBottomButton(
                    ...
                    onTapButton: () {
                      BlocProvider.of<BleCommissioningCubit>(context)
                          .actionBleStartPairingAction2(ApplianceType.DUAL_ZONE_WINE_CHILLER,
                              () {
                            globals.routeNameToBack = Routes.WINE_CENTER_DESCRIPTION;
                            Navigator.of(context).pushNamed(Routes.WINE_CENTER_APPLIANCE_INFO);
