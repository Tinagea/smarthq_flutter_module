...
class PageUnderCounterIcemakerDescription extends StatefulWidget {
  PageUnderCounterIcemakerDescription({Key? key}) : super(key: key);

  _PageUnderCounterIcemakerDescription createState() => _PageUnderCounterIcemakerDescription();
}

class _PageUnderCounterIcemakerDescription extends State<PageUnderCounterIcemakerDescription> with WidgetsBindingObserver {
          ...
          body: Component.componentCommissioningBody(
            ...
            <Widget>[
              ...
              BlocListener<BleCommissioningCubit, BleCommissioningState>(
                ...
                listener: (context, state) {
                  ...
                  if (state.isSuccess == true) {
                    ...
                    globals.routeNameToBack = Routes.UNDER_COUNTER_ICE_MAKER_DESCRIPTION;
                    Navigator.of(context).pushNamed(Routes.UNDER_COUNTER_ICE_MAKER_APPLIANCE_INFO);
                  }
                },
                child: Container(),
              ),
              Padding(
                ...
                child: Component.componentMainPngImage(context, ImagePath.UNDER_COUNTER_ICE_MAKER_DESCRIPTION),
              ),
              ...
              CustomRichText.addWifiTextBox(spanStringList: [
                TextSpan(
                    text: LocaleUtil.getString(context,
                        LocaleUtil.UNDER_COUNTER_ICE_MAKER_DESCRIPTION_TEXT_1),
                    style: textStyle_size_18_color_white()),
                TextSpan(
                    text: LocaleUtil.getString(context,
                        LocaleUtil.UNDER_COUNTER_ICE_MAKER_DESCRIPTION_TEXT_2),
                    style: textStyle_size_18_color_yellow()),
                TextSpan(
                    text: LocaleUtil.getString(context,
                        LocaleUtil.UNDER_COUNTER_ICE_MAKER_DESCRIPTION_TEXT_3),
                    style: textStyle_size_18_color_white()),
                TextSpan(
                    text: LocaleUtil.getString(context,
                        LocaleUtil.UNDER_COUNTER_ICE_MAKER_DESCRIPTION_TEXT_4),
                    style: textStyle_size_18_color_yellow()),
                TextSpan(
                    text: LocaleUtil.getString(context,
                        LocaleUtil.UNDER_COUNTER_ICE_MAKER_DESCRIPTION_TEXT_5),
                    style: textStyle_size_18_color_white()),
                WidgetSpan(
                  child: Icon(
                    Icons.wifi,
                ...
                TextSpan(
                    text: LocaleUtil.getString(context,
                        LocaleUtil.UNDER_COUNTER_ICE_MAKER_DESCRIPTION_TEXT_6),
                    style: textStyle_size_18_color_white()),
                ...
                return Component.componentBottomButton(
                    ...
                    onTapButton: () {
                      BlocProvider.of<BleCommissioningCubit>(context)
                          .actionBleStartPairingAction2(ApplianceType.UNDER_COUNTER_ICE_MAKER,
                              () {
                            globals.routeNameToBack = Routes.UNDER_COUNTER_ICE_MAKER_DESCRIPTION;
                            Navigator.of(context).pushNamed(Routes.UNDER_COUNTER_ICE_MAKER_APPLIANCE_INFO);
