...
class FridgeOnTopAppliancePasswordFnpPage extends StatefulWidget {
  FridgeOnTopAppliancePasswordFnpPage({Key? key}) : super(key: key);

  @override
  _FridgeOnTopAppliancePasswordFnpPageState createState() =>
      _FridgeOnTopAppliancePasswordFnpPageState();
}

class _FridgeOnTopAppliancePasswordFnpPageState extends State<FridgeOnTopAppliancePasswordFnpPage> {
                ...
                child: ListView(
                  ...
                  children: <Widget>[
                    Component.componentMainImageDynamicSize(
                        context: context,
                        imagePath: ImagePath.ONTOP_PASSWORD_INFO,
