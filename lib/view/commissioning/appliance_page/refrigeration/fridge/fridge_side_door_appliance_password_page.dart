...
class SideDoorEnterPasswordPage extends StatefulWidget {
  SideDoorEnterPasswordPage({Key? key}) : super(key: key);

  _SideDoorEnterPasswordPage createState() => _SideDoorEnterPasswordPage();
}

class _SideDoorEnterPasswordPage extends State<SideDoorEnterPasswordPage> {
