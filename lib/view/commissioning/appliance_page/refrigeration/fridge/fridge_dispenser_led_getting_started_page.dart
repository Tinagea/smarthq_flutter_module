...
class DispenserCommissioningModel2Step1 extends StatefulWidget {

  @override
  State createState() => _DispenserCommissioningModel2Step1();
}

class _DispenserCommissioningModel2Step1 extends State<DispenserCommissioningModel2Step1> with WidgetsBindingObserver {
                      ...
                      children: <Widget>[
                        ...
                        BlocListener<BleCommissioningCubit, BleCommissioningState>(
                          ...
                          listener: (context, state) {
                            ...
                            if (state.isSuccess == true) {
                              ...
                              globals.routeNameToBack = Routes.DISPENSER_DESCRIPTION2_MODEL2;
                              Navigator.of(context).pushNamed(Routes.DISPENSER_DESCRIPTION3_MODEL2);
                            }
                          },
                          child: Container(),
                        ),
                        Component.componentMainImage(context,
                            ImagePath.DISPENSER_TOP_CONTROLLER2_COLOR),
                        ...
                        CustomRichText.addWifiTextBox(
                            spanStringList: [
                              TextSpan(
                                  text: LocaleUtil.getString(context,
                                      LocaleUtil.DISPENSER_MODEL2_INSTRUCTION1)),
                              TextSpan(
                                  text: "Water ", style: textStyle_size_18_color_yellow()),
                              TextSpan(text: LocaleUtil.getString(context,
                                  LocaleUtil.AND)),
                              TextSpan(
                                  text: "Light ", style: textStyle_size_18_color_yellow()),
                              TextSpan(text: LocaleUtil.getString(context,
                                  LocaleUtil.DISPENSER_MODEL2_INSTRUCTION2)),
                              WidgetSpan(
                                child: Icon(
                                  Icons.wifi,
                                  size: 24.w,
                              ...
                              TextSpan(text: LocaleUtil.getString(context,
                                  LocaleUtil.DISPENSER_MODEL2_INSTRUCTION3))
                            ],
                        ...
                        Component.componentDescriptionTextWithLinkLabel(
                          contents: LocaleUtil.getString(
                              context, LocaleUtil.ICON_NOT_APPEARING)!,
                  ...
                  BlocBuilder<CommissioningCubit, CommissioningState>(
                      ...
                      builder: (context, state) {
                        return Component.componentBottomButton(
                            ...
                            onTapButton: () {
                              geaLog.debug("DispenserCommissioningModel2Step1 on tap");
