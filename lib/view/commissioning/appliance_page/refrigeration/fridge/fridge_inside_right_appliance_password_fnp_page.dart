...
class FridgeInsideRightAppliancePasswordFnpPage extends StatefulWidget {
  FridgeInsideRightAppliancePasswordFnpPage({Key? key}) : super(key: key);

  _FridgeInsideRightAppliancePasswordFnpPageState createState() =>
      _FridgeInsideRightAppliancePasswordFnpPageState();
}

class _FridgeInsideRightAppliancePasswordFnpPageState
    extends State<FridgeInsideRightAppliancePasswordFnpPage> {
                ...
                child: ListView(
                  ...
                  children: <Widget>[
                    Component.componentMainImageWithPadding(
                      context,
                      ImagePath.RIGHT_ON_WALL_APPLIANCE_INFORMATION_PASSWORD_2,
                      EdgeInsets.all(10),
                    ),
