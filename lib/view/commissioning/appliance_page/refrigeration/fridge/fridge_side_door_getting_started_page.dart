...
class SideDoorDescription1 extends StatefulWidget {
  SideDoorDescription1({Key? key}) : super(key: key);

  _SideDoorDescription1 createState() => _SideDoorDescription1();
}

class _SideDoorDescription1 extends State<SideDoorDescription1> with WidgetsBindingObserver {
          ...
          body: Component.componentCommissioningBody(
            ...
            <Widget>[
              ...
              BlocListener<BleCommissioningCubit, BleCommissioningState>(
                ...
                listener: (context, state) {
                  ...
                  if (state.isSuccess == true) {
                    ...
                    globals.routeNameToBack = Routes.SIDE_DOOR_DESCRIPTION1;
                    Navigator.of(context).pushNamed(Routes.SIDE_DOOR_DESCRIPTION2);
                  }
                },
                child: Container(),
              ),
              Component.componentMainImage(context, ImagePath.SIDE_DOOR_1),
              ...
              CustomRichText.addWifiTextBox(spanStringList: [
                TextSpan(
                  text: LocaleUtil.getString(context, LocaleUtil.SIDE_DOOR_DESCRIPTION_1_DIRECTION_1),
                ),
                WidgetSpan(
                  child: Icon(
                    Icons.wifi,
                ...
                TextSpan(
                  text: LocaleUtil.getString(context, LocaleUtil.SIDE_DOOR_DESCRIPTION_1_DIRECTION_2),
                )
