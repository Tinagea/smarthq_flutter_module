...
class OnTopCommissioningModel1Step1 extends StatefulWidget {

  @override
  State createState() => _OnTopCommissioningModel1Step1();
}

class _OnTopCommissioningModel1Step1 extends State<OnTopCommissioningModel1Step1> with WidgetsBindingObserver {
                  ...
                  BlocListener<BleCommissioningCubit, BleCommissioningState>(
                    ...
                    listener: (context, state) {
                      ...
                      if (state.isSuccess == true) {
                        ...
                        globals.routeNameToBack = Routes.ON_TOP_DESCRIPTION2_MODEL1;
                        Navigator.of(context).pushNamed(Routes.ON_TOP_DESCRIPTION3_MODEL1);
                      }
                    },
                    child: Container(),
                  ),
                    ...
                    child: ListView(
                      children: <Widget>[
                        Component.componentMainImage(
                            context, ImagePath.ONTOP_MAIN_MODEL1),
