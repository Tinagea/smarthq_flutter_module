...
class FridgeInsideRightGettingStartedFnpPage extends StatefulWidget {
  @override
  State createState() => _FridgeInsideRightGettingStartedFnpPageState();
}

class _FridgeInsideRightGettingStartedFnpPageState
    extends State<FridgeInsideRightGettingStartedFnpPage>
                  ...
                  child: ListView(
                    children: <Widget>[
                      Component.componentMainImage(
                        context,
                        ImagePath.RIGHT_ON_WALL_MAIN_MODEL1,
                      ),
                        ...
                        spanStringList: [
                          TextSpan(
                            text: LocaleUtil.getString(
                              context,
                              LocaleUtil
                                  .RIGHT_ON_WALL_UNLOCK_CONTROL_PANEL_INSTRUCTION_PART_1,
                            ),
                          ...
                          TextSpan(
                            text: LocaleUtil.getString(
                              context,
                              LocaleUtil
                                  .RIGHT_ON_WALL_UNLOCK_CONTROL_PANEL_INSTRUCTION_PART_2,
                            ),
                          ...
                          TextSpan(
                            text: LocaleUtil.getString(
                              context,
                              LocaleUtil
                                  .RIGHT_ON_WALL_UNLOCK_CONTROL_PANEL_INSTRUCTION_PART_3,
                            ),
                            style: textStyle_size_18_color_white(),
                          ),
                          TextSpan(
                            text: LocaleUtil.getString(
                              context,
                              LocaleUtil
                                  .RIGHT_ON_WALL_UNLOCK_CONTROL_PANEL_INSTRUCTION_PART_4,
                            ),
                            style: textStyle_size_18_color_yellow(),
                          ),
                          TextSpan(
                            text: LocaleUtil.getString(
                              context,
                              LocaleUtil
                                  .RIGHT_ON_WALL_UNLOCK_CONTROL_PANEL_INSTRUCTION_PART_5,
                            ),
                            style: textStyle_size_18_color_white(),
                          ),
                        ],
                    ...
                    return Component.componentBottomButton(
                      ...
                      onTapButton: () {
                        Navigator.of(context)
                            .pushNamed(Routes.RIGHT_ON_WALL_DESCRIPTION3_MODEL1);
                      },
                    );
                  },
                )
