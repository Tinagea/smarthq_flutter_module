...
class SideDoorDescription2 extends StatefulWidget {
  SideDoorDescription2({Key? key}) : super(key: key);

  _SideDoorDescription2 createState() => _SideDoorDescription2();
}

class _SideDoorDescription2 extends State<SideDoorDescription2> {
  @override
            ...
            Component.componentBottomButton(
                ...
                onTapButton: () {
                  Navigator.of(context)
                      .pushNamed(Routes.SIDE_DOOR_COMMISSIONING_ENTER_PASSWORD);
                }
            ),
          ),
        )
