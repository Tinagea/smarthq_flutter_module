...
class DispenserEnterPasswordPage1 extends StatefulWidget {
  DispenserEnterPasswordPage1({Key? key}) : super(key: key);

  _DispenserEnterPasswordPage1 createState() => _DispenserEnterPasswordPage1();
}

class _DispenserEnterPasswordPage1 extends State<DispenserEnterPasswordPage1> {
                        ...
                        child: ListView(
                          ...
                          children: <Widget>[
                            Component.componentMainImage(
                                context, ImagePath.WIFI_CONNECT_SCREEN),
                                ...
                                textSpanList: <TextSpan>[
                                  ...
                                  TextSpan(
                                      text: LocaleUtil.getString(
                                          context,
                                          LocaleUtil
                                              .FOUND_ON_YOUR_REFRIGERATOR_DISPLAY),
                                      style: textStyle_size_18_color_white()),
                                ]),
                            Column(
