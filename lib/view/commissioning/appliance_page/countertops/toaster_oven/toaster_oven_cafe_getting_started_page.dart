...
class ToasterOvenCafeCommissioningStep1 extends StatefulWidget {
  @override
  State createState() => _ToasterOvenCafeCommissioningStep1();
}

class _ToasterOvenCafeCommissioningStep1 extends State<ToasterOvenCafeCommissioningStep1> with WidgetsBindingObserver {
                      ...
                      children: <Widget>[
                        ...
                        BlocListener<BleCommissioningCubit, BleCommissioningState>(
                          ...
                          listener: (context, state) {
                            ...
                            if (state.isSuccess == true) {
                              ...
                              globals.routeNameToBack = Routes.TOASTER_OVEN_CAFE_DESCRIPTION1_MODEL;
                              Navigator.of(context).pushNamed(Routes.TOASTER_OVEN_DESCRIPTION2_MODEL);
                            }
                          },
                          child: Container(),
                        ),
                        Container(margin: EdgeInsets.fromLTRB(16.w, 0, 16.w, 0), child: Component.componentMainImage(context, ImagePath.TOASTER_OVEN_IMAGE1)),
                        ...
                        CustomRichText.customSpanListTextBox(
                          textSpanList: <TextSpan>[
                            TextSpan(text: LocaleUtil.getString(context, LocaleUtil.TOASTER_OVEN_TAP_THE)! + " ", style: textStyle_size_18_color_white()),
                            TextSpan(text: LocaleUtil.getString(context, LocaleUtil.SETTINGS), style: textStyle_size_18_color_yellow()),
                            TextSpan(text: LocaleUtil.getString(context, LocaleUtil.TOASTER_OVEN_AND_PUSH_THE), style: textStyle_size_18_color_white()),
                            TextSpan(text: LocaleUtil.getString(context, LocaleUtil.TOASTER_OVEN_TEMP_TIME), style: textStyle_size_18_color_yellow()),
                            TextSpan(text: LocaleUtil.getString(context, LocaleUtil.TOASTER_OVEN_KNOB_TO_SELECT), style: textStyle_size_18_color_white())
                          ],
                        ),
