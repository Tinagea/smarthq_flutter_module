...
class OpalDescription3 extends StatefulWidget {
  @override
  _OpalDescription3State createState() => _OpalDescription3State();
}

class _OpalDescription3State extends State<OpalDescription3> {
                        ...
                        child: ListView(
                          ...
                          children: <Widget>[
                            Component.componentMainImage(context,
                                ImagePath.OPAL_APPLIANCE_PASSWORD_INFO),
