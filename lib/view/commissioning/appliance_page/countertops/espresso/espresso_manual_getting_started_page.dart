...
class ManualEspressoModuleStep1 extends StatefulWidget {
  @override
  State createState() => _ManualEspressoModuleStep1();
}

class _ManualEspressoModuleStep1 extends State<ManualEspressoModuleStep1> with WidgetsBindingObserver {
                    ...
                    child: ListView(
                      ...
                      children: <Widget>[
                        ...
                        BlocListener<BleCommissioningCubit, BleCommissioningState>(
                          ...
                          listener: (context, state) {
                            ...
                            if (state.isSuccess == true) {
                              ...
                              globals.routeNameToBack = Routes.ESPRESSO_MANUAL_ONE;
                              Navigator.of(context).pushNamed(Routes.ESPRESSO_MANUAL_TWO);
                            }
                          },
                          child: Container(),
                        ),
                        BaseComponent.heightSpace(40.h),
                        Component.componentMainSmallImage(context, ImagePath.ESPRESSO_MANUAL_INITIAL_SCREEN),
                        BaseComponent.heightSpace(40.h),
                        ...
                        CustomRichText.addWifiTextBox(
                            spanStringList: [
                              TextSpan(
                                  text: LocaleUtil.getString(context, LocaleUtil.ESPRESSO_DESCRIPTION_1),
                                  style: textStyle_size_18_color_white()),
                              TextSpan(
                                  text: 'Single ',
                                  style: textStyle_size_18_color_yellow()),
                              TextSpan(
                                  text: LocaleUtil.getString(context, LocaleUtil.AND),
                                  style: textStyle_size_18_color_white()),
                              TextSpan(
                                  text: 'Double ',
                                  style: textStyle_size_18_color_yellow()),
                              TextSpan(
                                  text: LocaleUtil.getString(context, LocaleUtil.ESPRESSO_DESCRIPTION_1_1),
                                  style: textStyle_size_18_color_white()),
                              WidgetSpan(
                                child: Icon(
                                  Icons.wifi,
                              ...
                              TextSpan(
                                  text: LocaleUtil.getString(context, LocaleUtil.ESPRESSO_DESCRIPTION_1_2),
                                  style: textStyle_size_18_color_white()),
                            ],
                  ...
                  BlocBuilder<CommissioningCubit, CommissioningState>(
                      ...
                      builder: (context, state) {
                        return Component.componentBottomButton(
                            ...
                            onTapButton: () {
                              BlocProvider.of<BleCommissioningCubit>(context).actionBleStartPairingAction2(ApplianceType.ESPRESSO_COFFEE_MAKER, () {
                                globals.routeNameToBack = Routes.ESPRESSO_MANUAL_ONE;
                                Navigator.of(context).pushNamed(Routes.ESPRESSO_MANUAL_TWO);
