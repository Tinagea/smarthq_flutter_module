...
class ManualEspressoModuleStep3 extends StatefulWidget {
  ManualEspressoModuleStep3({Key? key}) : super(key: key);

  _ManualEspressoModuleStep3 createState() => _ManualEspressoModuleStep3();
}

class _ManualEspressoModuleStep3 extends State<ManualEspressoModuleStep3> {
                  ...
                  return Column(
                    children: [
                        ...
                        child: ListView(
                          ...
                          children: <Widget>[
                            ...
                            CustomRichText.customSpanListTextBox(textSpanList: <TextSpan>[
                              TextSpan(text: LocaleUtil.getString(context, LocaleUtil.ENTER_PASSWORD_TEXT_1), style: textStyle_size_18_color_white()),
                              TextSpan(text: LocaleUtil.getString(context, LocaleUtil.ENTER_PASSWORD_TEXT_2), style: textStyle_size_18_color_yellow()),
                              TextSpan(text: LocaleUtil.getString(context, LocaleUtil.ENTER_PASSWORD_TEXT_3), style: textStyle_size_18_color_white())
                            ]),
                            BaseComponent.heightSpace(16.h),
                            Column(
                      ...
                      Component.componentBottomButton(
                          isEnabled: (_passwordTextFieldStatus == TextFieldStatus.equalToMaxLength) && (_geModuleTextFieldStatus == TextFieldStatus.equalToMaxLength || !_isAutoJoinSupport),
