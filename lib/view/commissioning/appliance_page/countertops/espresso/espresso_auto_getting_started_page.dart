...
class AutoEspressoModuleStep1 extends StatefulWidget {
  @override
  State createState() => _AutoEspressoModuleStep1();
}

class _AutoEspressoModuleStep1 extends State<AutoEspressoModuleStep1> with WidgetsBindingObserver {
                    ...
                    child: ListView(
                      children: <Widget>[
                        ...
                        BlocListener<BleCommissioningCubit, BleCommissioningState>(
                          ...
                          listener: (context, state) {
                            ...
                            if (state.isSuccess == true) {
                              ...
                              globals.routeNameToBack = Routes.ESPRESSO_AUTO_ONE;
                              Navigator.of(context).pushNamed(Routes.ESPRESSO_AUTO_TWO);
                            }
                          },
                          child: Container(),
                        ),
                        BaseComponent.heightSpace(40.h),
                        Component.componentMainSmallImage(context, ImagePath.ESPRESSO_AUTO_INITIAL_SCREEN),
                        BaseComponent.heightSpace(40.h),
                        ...
                        CustomRichText.addWifiTextBox(spanStringList: [
                          TextSpan(text: LocaleUtil.getString(context, LocaleUtil.ESPRESSO_DESCRIPTION_1),
