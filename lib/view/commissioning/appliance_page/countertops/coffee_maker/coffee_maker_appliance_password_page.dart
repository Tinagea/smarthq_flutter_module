...
class CoffeeMakerPassword extends StatefulWidget {
  CoffeeMakerPassword({Key? key}) : super(key: key);

  _CoffeeMakerPassword createState() => _CoffeeMakerPassword();
}

class _CoffeeMakerPassword extends State<CoffeeMakerPassword> {
