...
class DishwasherDescription3 extends StatefulWidget {
  DishwasherDescription3({Key? key}) : super(key: key);

  _DishwasherDescription3 createState() => _DishwasherDescription3();
}

class _DishwasherDescription3 extends State<DishwasherDescription3> {
                        ...
                        child: ListView(
                          ...
                          children: <Widget>[
                            Component.componentMainImage(context,
                                ImagePath.DISHWASHER_PASSWORD_ENTRY),
                                ...
                                textSpanList: <TextSpan>[
                                  TextSpan(
                                      text: LocaleUtil.getString(
                                          context, LocaleUtil.DISHWASHER_PASSWORD_INFO),
                                      style: TextStyle(
                                          fontSize: 18.0,
                                          color: Colors.white,
