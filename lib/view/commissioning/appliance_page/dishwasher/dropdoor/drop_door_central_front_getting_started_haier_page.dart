...
class DropDoorCentralFrontGettingStartedHaierPage extends StatefulWidget {
  const DropDoorCentralFrontGettingStartedHaierPage({Key? key}) : super(key: key);

  @override
  State<DropDoorCentralFrontGettingStartedHaierPage> createState() =>
      _DropDoorCentralFrontGettingStartedHaierPageState();
}

class _DropDoorCentralFrontGettingStartedHaierPageState
    extends State<DropDoorCentralFrontGettingStartedHaierPage>
      ...
      children: [
        ...
        Padding(
          ...
          child: SvgPicture.asset(
            ImagePath.DROP_DOOR_CENTRAL_FRONT_OF_DOOR_CONTROL_STEP_1_SVG,
          ),
        ),
            ...
            spanStringList: [
              TextSpan(
                text: LocaleUtil.getString(
                    context,
                    LocaleUtil
                        .DROP_DOOR_CENTRAL_FRONT_OF_DOOR_HAIER_INSTRUCTION_1_PART_1),
              ...
              TextSpan(
                text: LocaleUtil.getString(
                    context,
                    LocaleUtil
                        .DROP_DOOR_CENTRAL_FRONT_OF_DOOR_HAIER_INSTRUCTION_1_PART_2),
            ...
            return Component.componentBottomButton(
              ...
              onTapButton: () {
                Navigator.of(context)
                    .pushNamed(Routes.DROP_DOOR_CENTRAL_FRONT_OF_DOOR_HAIER_STEP2);
              },
            );
          },
        ),
