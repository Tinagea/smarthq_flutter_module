...
class DropDoorInsideTopAppliancePasswordHaierPage extends StatefulWidget {
  DropDoorInsideTopAppliancePasswordHaierPage({Key? key}) : super(key: key);

  @override
  State<DropDoorInsideTopAppliancePasswordHaierPage> createState() =>
      _DropDoorInsideTopAppliancePasswordHaierPageState();
}

class _DropDoorInsideTopAppliancePasswordHaierPageState
    extends State<DropDoorInsideTopAppliancePasswordHaierPage> {
                  ...
                  children: <Widget>[
                    Padding(
                      ...
                      child: Component.componentMainImage(context,
                          ImagePath.DROP_DOOR_INSIDE_TOP_CONTROL_HAIER_ENTER_PASSWORD_INFO),
                    ),
