...
class DropDoorCentralFrontEnableCommissioningHaierPage2 extends StatelessWidget {
  const DropDoorCentralFrontEnableCommissioningHaierPage2({Key? key}) : super(key: key);
      ...
      children: [
        ...
        Padding(
          ...
          child: SvgPicture.asset(
            ImagePath.DROP_DOOR_CENTRAL_FRONT_OF_DOOR_CONTROL_STEP_3_SVG,
          ),
        ),
            ...
            spanStringList: [
              TextSpan(
                text: LocaleUtil.getString(
                    context,
                    LocaleUtil
                        .DROP_DOOR_CENTRAL_FRONT_OF_DOOR_HAIER_INSTRUCTION_3_PART_1),
              ...
              TextSpan(
                text: LocaleUtil.getString(
                    context,
                    LocaleUtil
                        .DROP_DOOR_CENTRAL_FRONT_OF_DOOR_HAIER_INSTRUCTION_3_PART_2),
              ...
              TextSpan(
                text: LocaleUtil.getString(
                    context,
                    LocaleUtil
                        .DROP_DOOR_CENTRAL_FRONT_OF_DOOR_HAIER_INSTRUCTION_3_PART_3),
                style: textStyle_size_18_color_white(),
              ),
            ],
          ),
        ...
        Component.componentBottomButton(
            ...
            onTapButton: () {
              Navigator.of(context)
                  .pushNamed(Routes.DROP_DOOR_CENTRAL_FRONT_OF_DOOR_HAIER_STEP4);
            }),
