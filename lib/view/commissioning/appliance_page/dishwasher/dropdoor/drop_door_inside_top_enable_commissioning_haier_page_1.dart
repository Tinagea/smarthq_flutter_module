...
class DropDoorInsideTopEnableCommissioningHaierPage1 extends StatelessWidget {
  const DropDoorInsideTopEnableCommissioningHaierPage1({Key? key}) : super(key: key);
      ...
      children: [
        ...
        Padding(
          ...
          child: SvgPicture.asset(
            ImagePath.DROP_DOOR_INSIDE_TOP_CONTROL_HAIER_STEP_2,
          ),
        ),
            ...
            spanStringList: [
              TextSpan(
                text: LocaleUtil.getString(
                    context,
                    LocaleUtil
                        .DROP_DOOR_INSIDE_TOP_HAIER_INSTRUCTION_2_PART_1),
              ...
              TextSpan(
                text: LocaleUtil.getString(
                    context,
                    LocaleUtil
                        .DROP_DOOR_INSIDE_TOP_HAIER_INSTRUCTION_2_PART_2),
              ...
              TextSpan(
                text: LocaleUtil.getString(
                    context,
                    LocaleUtil
                        .DROP_DOOR_INSIDE_TOP_HAIER_INSTRUCTION_2_PART_3),
                style: textStyle_size_18_color_white(),
              ),
            ],
          ),
        ...
        Component.componentBottomButton(
          ...
          onTapButton: () {
            Navigator.of(context)
                .pushNamed(Routes.DROP_DOOR_INSIDE_TOP_HAIER_STEP3);
          },
        ),
