...
class DropDoorOnFrontAppliancePasswordFnpPage extends StatefulWidget {
  DropDoorOnFrontAppliancePasswordFnpPage({Key? key}) : super(key: key);

  @override
  State<DropDoorOnFrontAppliancePasswordFnpPage> createState() =>
      _DropDoorOnFrontAppliancePasswordFnpPageState();
}

class _DropDoorOnFrontAppliancePasswordFnpPageState
    extends State<DropDoorOnFrontAppliancePasswordFnpPage> {
                  ...
                  children: <Widget>[
                    Padding(
                      ...
                      child: Component.componentMainImage(context,
                          ImagePath.DROP_DOOR_ON_FRONT_OF_DOOR_ENTER_PASSWORD_INFO_SVG),
                    ),
