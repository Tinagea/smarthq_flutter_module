...
class DropDoorCentralFrontAppliancePasswordHaierPage extends StatefulWidget {
  DropDoorCentralFrontAppliancePasswordHaierPage({Key? key}) : super(key: key);

  @override
  State<DropDoorCentralFrontAppliancePasswordHaierPage> createState() =>
      _DropDoorCentralFrontAppliancePasswordHaierPageState();
}

class _DropDoorCentralFrontAppliancePasswordHaierPageState
    extends State<DropDoorCentralFrontAppliancePasswordHaierPage> {
                  ...
                  children: <Widget>[
                    Padding(
                      ...
                      child: Component.componentMainImage(context,
                          ImagePath.DROP_DOOR_CENTRAL_FRONT_OF_DOOR_ENTER_PASSWORD_INFO),
                    ),
