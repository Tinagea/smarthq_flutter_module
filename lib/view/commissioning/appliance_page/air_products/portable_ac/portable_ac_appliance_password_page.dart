...
class PortableACPasswordPage extends StatefulWidget {
  PortableACPasswordPage({Key? key}) : super(key: key);

  _PortableACPasswordPage createState() => _PortableACPasswordPage();
}

class _PortableACPasswordPage extends State<PortableACPasswordPage> {
                    ...
                    children: [
                      Expanded(
                        child: ListView(
                          ...
                          shrinkWrap: true,
                          children: <Widget>[
                            Component.componentMainImage(context, ImagePath.PORTABLE_AC_APPLIANCE_PASSWORD_INFO),
