...
class USBWifiACHome extends StatefulWidget {
  const USBWifiACHome({Key? key}) : super(key: key);
  @override
  State createState() => _USBWifiACHome();
}

class _USBWifiACHome extends State<USBWifiACHome>
                        ...
                        BlocListener<BleCommissioningCubit, BleCommissioningState>(
                          ...
                          listener: (context, state) {
                            ...
                            if (state.isSuccess == true) {
                              ...
                              globals.routeNameToBack = Routes.DUCTLESS_AC_USB_WIFI_DESCRIPTION_PAGE;
                              Navigator.of(context).pushNamed(Routes.DUCTLESS_AC_BUILT_IN_WIFI_DESC_PAGE_1);
                            }
                          },
                          child: Container(),
                        ),
                          ...
                          textSpanList: <TextSpan>[
                            TextSpan(
                                text: LocaleUtil.getString(
                                    context,
                                    LocaleUtil
                                        .USB_WIFI_DESCRIPTION),
                                style: textStyle_size_18_color_white()),
                          ],
                        ),
                        BaseComponent.heightSpace(16.h),
                        Component.componentCenterDescriptionText(text: LocaleUtil.getString(context,
                            LocaleUtil.WIFI_MODULE_IS_ALREADY_CONNECTED)!,marginInsets: EdgeInsets.all(24)),
                      ],
                    ),
                  ),
                        ...
                        return Component.componentBottomButton(
                            ...
                            onTapButton: () {
                              BlocProvider.of<BleCommissioningCubit>(context)
                                  .actionBleStartPairingAction2(ApplianceType.SPLIT_AIR_CONDITIONER, () {
                                    geaLog.debug("USBWifiACHome on tap");
                                    globals.routeNameToBack = Routes.DUCTLESS_AC_USB_WIFI_DESCRIPTION_PAGE;
                                    Navigator.of(context).pushNamed(Routes.DUCTLESS_AC_BUILT_IN_WIFI_DESC_PAGE_1);
                                  });
                            });
