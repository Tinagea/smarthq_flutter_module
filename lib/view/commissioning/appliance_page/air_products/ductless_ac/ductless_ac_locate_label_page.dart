...
class DuctlessACApplianceInfoPage extends StatefulWidget {
  DuctlessACApplianceInfoPage({Key? key}) : super(key: key);

  _DuctlessACApplianceInfoPage createState() => _DuctlessACApplianceInfoPage();
}

class _DuctlessACApplianceInfoPage extends State<DuctlessACApplianceInfoPage> {
  @override
        ...
        child: Scaffold(
          ...
          body: Component.componentCommissioningBody(
            ...
            <Widget>[
              ...
              Component.componentMainPngImage(context, ImagePath.DUCTLESS_AC_APPLIANCE_INFO),
              BaseComponent.heightSpace(16.h),
              CustomRichText.customSpanListTextBox(
                textSpanList: <TextSpan>[
                  TextSpan(
                      text: LocaleUtil.getString(context, LocaleUtil.FIND_NETWORK_AND_PASSWORD_ON_CONNECTED_APPLIANCE),
            ...
            Component.componentBottomButton(
                ...
                onTapButton: () {
                  Navigator.of(context)
                      .pushNamed(Routes.DUCTLESS_AC_APPLIANCE_PASSWORD_INFO_PAGE);
                }
            ),
          ),
        )
