...
class BuildInWifiACHome extends StatefulWidget {
  const BuildInWifiACHome({Key? key}) : super(key: key);
  @override
  State createState() => _BuildInWifiACHome();
}

class _BuildInWifiACHome extends State<BuildInWifiACHome>
                  ...
                  Expanded(
                    child: ListView(
                      children: <Widget>[
                        ...
                        BlocListener<BleCommissioningCubit, BleCommissioningState>(
                          listenWhen: (previous, current) {
                            return (current.stateType == BleCommissioningStateType.HIDE_PAIRING_LOADING && (ModalRoute.of(context) != null && ModalRoute.of(context)!.isCurrent));
                          },
                          listener: (context, state) {
                        ...
                        BlocListener<BleCommissioningCubit, BleCommissioningState>(
                          ...
                          listener: (context, state) {
                            ...
                            if (state.isSuccess == true) {
                              ...
                              globals.routeNameToBack = Routes.DUCTLESS_AC_BUILT_IN_WIFI_DESC_PAGE_1;
                              Navigator.of(context).pushNamed(Routes.DUCTLESS_AC_APPLIANCE_INFO_PAGE);
                            }
                          },
                          child: Container(),
                        ),
                        ...
                        Component.componentMainPngImage(
                            context, ImagePath.BUILT_IN_AC_DESCRIPTION),
                        ...
                        CustomRichText.customSpanListTextBox(
                          textSpanList: <TextSpan>[
                            ...
                            TextSpan(
                                text: LocaleUtil.getString(
                                    context, LocaleUtil.REMOTE_CONTROLLER),
                                style: textStyle_size_18_color_yellow()),
                            TextSpan(
                                text: LocaleUtil.getString(
                                    context, LocaleUtil.PRESS),
                                style: textStyle_size_18_color_white()),
                            TextSpan(
                                text: LocaleUtil.getString(
                                    context, LocaleUtil.POWER),
                                style: textStyle_size_18_color_yellow()),
                            TextSpan(
                                text: LocaleUtil.getString(
                                    context, LocaleUtil.BUTTON_TO_TURN_ON_THE_UNIT),
                                style: textStyle_size_18_color_white()),
                            TextSpan(
                                text: LocaleUtil.getString(
                                    context, LocaleUtil.POWER),
                            ...
                            TextSpan(
                                text: LocaleUtil.getString(
                                    context, LocaleUtil.BUTTON_FOR_5_SECONDS),
                                style: textStyle_size_18_color_white()),
                            TextSpan(
                                text: LocaleUtil.getString(
                                    context, LocaleUtil.WIRED_CONTROLLER),
                                style: textStyle_size_18_color_yellow()),
                            TextSpan(
                                text: LocaleUtil.getString(
                                    context, LocaleUtil.SET_THE_UNIT_TO_COOL),
                                style: textStyle_size_18_color_white()),
                          ],
                        ),
                  ...
                  BlocBuilder<CommissioningCubit, CommissioningState>(
                      ...
                      builder: (context, state) {
                        return Component.componentBottomButton(
                            ...
                            onTapButton: () {
                              BlocProvider.of<BleCommissioningCubit>(context).actionBleStartPairingAction2(ApplianceType.SPLIT_AIR_CONDITIONER, () {
                                geaLog.debug("BuildInWifiACHome on tap");
                                globals.routeNameToBack = Routes.DUCTLESS_AC_BUILT_IN_WIFI_DESC_PAGE_1;
                                Navigator.of(context).pushNamed(Routes.DUCTLESS_AC_APPLIANCE_INFO_PAGE);
