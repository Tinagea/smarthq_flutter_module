...
class DuctlessACPassword extends StatefulWidget {
  DuctlessACPassword({Key? key}) : super(key: key);

  _DuctlessACPassword createState() => _DuctlessACPassword();
}

class _DuctlessACPassword extends State<DuctlessACPassword> {
                    ...
                    children: [
                      Expanded(
                        child: ListView(
                          ...
                          shrinkWrap: true,
                          children: <Widget>[
                            Component.componentMainPngImage(context, ImagePath.DUCTLESS_AC_APPLIANCE_PASSWORD_INFO),
