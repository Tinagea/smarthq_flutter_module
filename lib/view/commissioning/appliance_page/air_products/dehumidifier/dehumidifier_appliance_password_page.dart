...
class DehumidifierStep3 extends StatefulWidget {
  DehumidifierStep3({Key? key}) : super(key: key);

  _DehumidifierStep3 createState() => _DehumidifierStep3();
}

class _DehumidifierStep3 extends State<DehumidifierStep3> {
                    ...
                    children: [
                      Expanded(
                        child: ListView(
                          ...
                          shrinkWrap: true,
                          children: <Widget>[
                            Component.componentMainImage(context, ImagePath.DEHUMIDIFIER_PASSWORD),
                            ...
                            CustomRichText.customSpanListTextBox(textSpanList: <TextSpan>[
                              TextSpan(text: LocaleUtil.getString(context, LocaleUtil.DEHUMIDIFIER_PASSWORD_EXPLAIN), style: textStyle_size_18_color_white()),
                            ]),
                            BaseComponent.heightSpace(16.h),
                            Column(
