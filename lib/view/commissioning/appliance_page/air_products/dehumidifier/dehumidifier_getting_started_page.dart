...
class DehumidifierStep1 extends StatefulWidget {

  @override
  State createState() => _DehumidifierStep1();

}


class _DehumidifierStep1 extends State<DehumidifierStep1> with WidgetsBindingObserver {
                      ...
                      children: <Widget>[
                        ...
                        BlocListener<BleCommissioningCubit, BleCommissioningState>(
                          ...
                          listener: (context, state) {
                            ...
                            if (state.isSuccess == true) {
                              ...
                              globals.routeNameToBack = Routes.DEHUMIDIFIER_DESCRIPTION1;
                              Navigator.of(context).pushNamed(Routes.DEHUMIDIFIER_DESCRIPTION2);
                            }
                          },
                          child: Container(),
                        ),
                        Component.componentMainImage(context,
                            ImagePath.DEHUMIDIFIER_INITIAL_SCREEN),
                        ...
                        CustomRichText.addWifiTextBox(
                            spanStringList: [
                              TextSpan(
                                  text: LocaleUtil.getString(context,
                                      LocaleUtil.DEHUMIDIFIER_DESCRIPTION_TEXT_1)!,
                              ...
                              TextSpan(
                                  text: LocaleUtil.getString(context,
                                      LocaleUtil.DEHUMIDIFIER_DESCRIPTION_TEXT_2)!,
                                  style: textStyle_size_18_color_white()),
                              TextSpan(
                                  text: LocaleUtil.getString(context,
                                      LocaleUtil.DEHUMIDIFIER_DESCRIPTION_TEXT_3)!,
                                  style: textStyle_size_18_color_yellow()),
                              TextSpan(
                                  text: LocaleUtil.getString(context,
                                      LocaleUtil.DEHUMIDIFIER_DESCRIPTION_TEXT_4)!,
                                  style: textStyle_size_18_color_white()),
                              ...
                              TextSpan(
                                  text: LocaleUtil.getString(context,
                                      LocaleUtil.DEHUMIDIFIER_DESCRIPTION_TEXT_5)!,
                                  style: textStyle_size_18_color_white()),
                            ],
                        ...
                        return Component.componentBottomButton(
                            ...
                            onTapButton: () {
                              BlocProvider.of<BleCommissioningCubit>(context)
                                  .actionBleStartPairingAction2(ApplianceType.DEHUMIDIFIER, () {
                                    geaLog.debug("DehumidifierStep1 on tap");
                                    globals.routeNameToBack = Routes.DEHUMIDIFIER_DESCRIPTION1;
                                    Navigator.of(context).pushNamed(Routes.DEHUMIDIFIER_DESCRIPTION2);
