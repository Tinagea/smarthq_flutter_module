...
class WindowACPassword extends StatefulWidget {
  @override
  _WindowACPassword createState() => _WindowACPassword();
}

class _WindowACPassword extends State<WindowACPassword> {
                    ...
                    children: [
                      Expanded(
                        child: ListView(
                          ...
                          shrinkWrap: true,
                          children: <Widget>[
                            Component.componentMainImage(context, ImagePath.WINDOW_AC_PASSWORD),
                            ...
                            Visibility(
                              child: Padding(
                                ...
                                child: CommissioningPassword().getGEModuleNameTextField(
                                    context: context,
                                    title: LocaleUtil.getString(context, LocaleUtil.GE_MODULE_PREFIX),
                            ...
                            CustomRichText.customSpanListTextBox(textSpanList: <TextSpan>[
                              TextSpan(text: LocaleUtil.getString(context, LocaleUtil.WINDOW_AC_SETUP_DESC_8), style: textStyle_size_18_color_white()),
                              TextSpan(text: LocaleUtil.getString(context, LocaleUtil.WINDOW_AC_SETUP_DESC_9), style: textStyle_size_18_color_white()),
                            ]),
                            Column(
