...
class WindowACHome extends StatefulWidget {
  @override
  _WindowACHomeState createState() => _WindowACHomeState();
}

class _WindowACHomeState extends State<WindowACHome> with WidgetsBindingObserver{
      ...
      body: Component.componentCommissioningBodyWithBottomItem(
        ...
        <Widget>[
          ...
          BlocListener<BleCommissioningCubit, BleCommissioningState>(
            ...
            listener: (context, state) {
              ...
              if (state.isSuccess == true) {
                ...
                globals.routeNameToBack = Routes.WINDOW_AC_PAGE_1;
          ...
          Component.componentDescriptionText(
              text: LocaleUtil.getString(context, LocaleUtil.WINDOW_AC_SETUP_DESC_1)!,
              marginInsets: EdgeInsets.symmetric(horizontal: 28)),
          BaseComponent.heightSpace(16),
            ...
            spanStringList: [
              TextSpan(
                  text: LocaleUtil.getString(
                      context, LocaleUtil.WINDOW_AC_SETUP_DESC_10),
                  style: textStyle_size_18_color_white()),
              TextSpan(
                  text: LocaleUtil.getString(
                      context, LocaleUtil.WINDOW_AC_SETUP_DESC_2),
                  style: textStyle_size_18_color_white()),
              TextSpan(
                  text: LocaleUtil.getString(
                      context, LocaleUtil.WINDOW_AC_SETUP_DESC_3),
                  style: textStyle_size_18_color_yellow()),
              TextSpan(
                  text: LocaleUtil.getString(
                      context, LocaleUtil.WINDOW_AC_SETUP_DESC_4),
                  style: textStyle_size_18_color_white()),
              TextSpan(
                  text: LocaleUtil.getString(
                      context, LocaleUtil.WINDOW_AC_SETUP_DESC_5),
                  style: textStyle_size_18_color_yellow()),
              TextSpan(
                  text: LocaleUtil.getString(
                      context, LocaleUtil.WINDOW_AC_SETUP_DESC_6),
                  style: textStyle_size_18_color_white()),
            ],
        ...
        Component.componentWhiteOutlinedButton(LocaleUtil.getString(context, LocaleUtil.LIGHT_IS_NOT_BLINKING)!, () {
          globals.routeNameToBack = Routes.WINDOW_AC_PAGE_1;
          Navigator.of(context).pushNamed(Routes.WINDOW_AC_PAGE_4);
        }),
